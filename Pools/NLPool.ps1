...
$Wallet = $Config.PoolsConfig.$Name_Norm.Wallets.($Config.PoolsConfig.$Name_Norm.PayoutCurrency)
    ...
    $Request | Get-Member -MemberType NoteProperty | Select-Object -ExpandProperty Name | ForEach-Object { 
        ...
        ForEach ($Region in $PoolRegions) { 
            ...
            [PSCustomObject]@{ 
                ...
                User               = [String]$Wallet
                Pass               = "$($Config.PoolsConfig.$Name_Norm.WorkerName),c=$($Config.PoolsConfig.$Name_Norm.PayoutCurrency)"
