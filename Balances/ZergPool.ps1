...
Try { 
    $APIResponse = Invoke-RestMethod "http://www.zergpool.com:8080/api/wallet?address=$($Config.PoolsConfig.$Name.Wallet)" -UseBasicParsing -TimeoutSec 10 -ErrorAction Stop
