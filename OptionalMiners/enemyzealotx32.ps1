...
$Path = ".\Bin\NVIDIA-enemyzealotx32\z-enemy.exe"
$Uri = "http://nemos.dx.am/opt/nemos/z-enemy.1-19-cuda9.2_x32.zip"
...
#"c11" = "" #C11 (trex faster)
#"xevan" = "" #Xevan (x64 slighty faster/ccminerxevan7.5/9 faster)
#"x17" = "" #X17 (trex faster)
