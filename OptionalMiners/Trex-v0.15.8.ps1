...
#   "AstralHash"      = " --algo astralhash --intensity 23"
    "Balloon"         = " --algo balloon --intensity 23"
...
#   "PadiHash"        = " --algo padihash --intensity 23"
    ...
    "Polytimos"       = " --algo polytimos --intensity 25"
...
#   "BitcoinInterest" = " --algo progpow --coin BCI --intensity 21" #Does not work
    "Sha256t"         = " --algo sha256t --intensity 26"
    "Sha256q"         = " --algo sha256q --intensity 23"
    "Sonoa"           = " --algo sonoa --intensity 23"
    "Timetravel"      = " --algo timetravel --intensity 25"
