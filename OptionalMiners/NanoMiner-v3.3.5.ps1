...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "Autolykos2";   Type = "AMD"; Fee = 0.05; MinMemGB = 2; MinerSet = 0; WarmupTimes = @(0, 0);  Coin= "Autolykos" }
    ...
    [PSCustomObject]@{ Algorithm = "Autolykos2";   Type = "NVIDIA"; Fee = 0.05; MinMemGB = 2; MinerSet = 0; WarmupTimes = @(0, 0);  Coin= "Autolykos" }
