...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "Autolykos2";   Type = "AMD"; Fee = 0.025; MinMemGB = 2; MinerSet = 0; WarmupTimes = @(0, 0);  Coin= "Autolykos" }
    ...
    [PSCustomObject]@{ Algorithm = "Randomx";   Type = "CPU"; Fee = 0.02; MinerSet = 0; WarmupTimes = @(0, 30); Coin = "RandomX" } # XmRig-v6.10.0 is fastest
    [PSCustomObject]@{ Algorithm = "VerusHash"; Type = "CPU"; Fee = 0.02; MinerSet = 0; WarmupTimes = @(0, 30); Coin = "VerusHash" }

    [PSCustomObject]@{ Algorithm = "Autolykos2";   Type = "NVIDIA"; Fee = 0.025; MinMemGB = 2; MinerSet = 0; WarmupTimes = @(0, 0);  Coin= "Autolykos" }
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";       Type = "NVIDIA"; Fee = 0.01;  MinMemGB = 3; MinerSet = 1; WarmupTimes = @(0, 30); Coin= "Kawpow" } # Trex-v0.20.4 is fastest
    [PSCustomObject]@{ Algorithm = "Octopus";      Type = "NVIDIA"; Fee = 0.02;  MinMemGB = 4; MinerSet = 1; WarmupTimes = @(0, 30); Coin= "Octopus" } # NBMiner-v37.5 is faster
