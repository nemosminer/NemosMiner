...
$Uri = "https://github.com/Minerx117/miners/releases/download/MiniZ/miniZ_v1.7x2_winx64.zip"
$DeviceEnumerator = "Type_Vendor_Slot"

$AlgorithmDefinitions = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "BeamV3";       MinMemGB = 4.0; Fee = 0.02;   MinerSet = 1; Arguments = " --par=beam3 --pers=Beam-PoW --ocX" } # NBMiner-v36.1 is fastest
