...
#    [PSCustomObject]@{ Algorithm = "BeamV2";        Type = "AMD"; Fee = 0.01;  MinMemGB = 3.0; MinerSet = 1; WarmupTime = 15; Arguments = " --algo BEAM-II" } # Algo is dead
    ...
    [PSCustomObject]@{ Algorithm = "EtcHash";       Type = "AMD"; Fee = 0.007; MinMemGB = 4.0; MinerSet = 2; WarmupTime = 30; Arguments = " --algo ETCHASH --disable-dag-verify 1" } # Ethereum Classic, PhoenixMiner-v5.6d is faster
    [PSCustomObject]@{ Algorithm = "Ethash";        Type = "AMD"; Fee = 0.007; MinMemGB = 4.0; MinerSet = 2; WarmupTime = 30; Arguments = " --algo ETHASH --disable-dag-verify 1" } # PhoenixMiner-v5.6d is faster
    [PSCustomObject]@{ Algorithm = "EthashLowMem";  Type = "AMD"; Fee = 0.007; MinMemGB = 3.0; MinerSet = 2; WarmupTime = 30; Arguments = " --algo ETHASH --disable-dag-verify 1" } # PhoenixMiner-v5.6d is faster
...
#    [PSCustomObject]@{ Algorithm = "BeamV2";        Type = "NVIDIA"; Fee = 0.01;  MinMemGB = 3.0; MinerSet = 1; WarmupTime = 15; Arguments = " --algo BEAM-II" } # Algo is dead
    ...
    [PSCustomObject]@{ Algorithm = "EtcHash";       Type = "NVIDIA"; Fee = 0.007; MinMemGB = 4.0; MinerSet = 2; WarmupTime = 30; Arguments = " --algo ETCHASH --disable-dag-verify 1" } # Ethereum Classic, PhoenixMiner-v5.6d is faster
    [PSCustomObject]@{ Algorithm = "Ethash";        Type = "NVIDIA"; Fee = 0.007; MinMemGB = 4.0; MinerSet = 2; WarmupTime = 30; Arguments = " --algo ETHASH --disable-dag-verify 1" } # PhoenixMiner-v5.6d is faster
    [PSCustomObject]@{ Algorithm = "EthashLowMem";  Type = "NVIDIA"; Fee = 0.007; MinMemGB = 3.0; MinerSet = 2; WarmupTime = 30; Arguments = " --algo ETHASH --disable-dag-verify 1" } # PhoenixMiner-v5.6d is faster
)
