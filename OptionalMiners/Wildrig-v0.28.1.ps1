...
#   [PSCustomObject]@{ Algorithm = "Honeycomb";   Fee = @(0.01); MinMemGB = 2; Type = "AMD"; Command = " --algo honeycomb" } #Algo broken
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";      Fee = @(0.01); MinMemGB = 3; Type = "AMD"; Command = " --algo kawpow" } #TeamRed-v0.7.16b is fastest on Navi
#   [PSCustomObject]@{ Algorithm = "Lyra2RE3";    Fee = @(0.01); MinMemGB = 2; Type = "AMD"; Command = " --algo lyra2v3" } #TeamRed-v0.7.16b is fastest
...
#   [PSCustomObject]@{ Algorithm = "MTP";         Fee = @(0.01); MinMemGB = 3; Type = "AMD"; Command = " --algo mtp" } #TeamRed-v0.7.16b is fastest
...
#   [PSCustomObject]@{ Algorithm = "X16r";        Fee = @(0.01); MinMemGB = 2; Type = "AMD"; Command = " --algo x16r" } #TeamRed-v0.7.16b is fastest
    [PSCustomObject]@{ Algorithm = "X16rt";       Fee = @(0.01); MinMemGB = 2; Type = "AMD"; Command = " --algo x16rt" }
#   [PSCustomObject]@{ Algorithm = "X16rv2";      Fee = @(0.01); MinMemGB = 2; Type = "AMD"; Command = " --algo x16rv2" } #TeamRed-v0.7.16b is fastest
...
#   [PSCustomObject]@{ Algorithm = "X21s";        Fee = @(0.01); MinMemGB = 2; Type = "AMD"; Command = " --algo x21s" } #TeamRed-v0.7.16b is fastest
...
#   [PSCustomObject]@{ Algorithm = "Honeycomb";   Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo honeycomb" } #Algo broken
    [PSCustomObject]@{ Algorithm = "JeongHash";   Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo glt-jeonghash" } #Trex-v0.18.5 is fastest
...
#   [PSCustomObject]@{ Algorithm = "MTP";         Fee = @(0.01); MinMemGB = 3; Type = "NVIDIA"; Command = " --algo mtp" } #Trex-v0.18.5 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "PawelHash";   Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo glt-pawelhash" } #Trex-v0.18.5 is fastest
...
#   [PSCustomObject]@{ Algorithm = "Sonoa";       Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo sonoa" } #Trex-v0.18.5 is fastest
...
#   [PSCustomObject]@{ Algorithm = "X16r";        Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo x16r" } #Trex-v0.18.5 is fastest
    [PSCustomObject]@{ Algorithm = "X16rt";       Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo x16rt" }
#   [PSCustomObject]@{ Algorithm = "X16rv2";      Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo x16rv2" } #Trex-v0.18.5 is fastest
#   [PSCustomObject]@{ Algorithm = "X16s";        Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo x16s" } #Trex-v0.18.5 is fastest
...
#   [PSCustomObject]@{ Algorithm = "X21s";        Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo x21s" } #Trex-v0.18.5 is fastest
#   [PSCustomObject]@{ Algorithm = "X22i";        Fee = @(0.01); MinMemGB = 2; Type = "NVIDIA"; Command = " --algo x22i" } #Trex-v0.18.5 is fastest
