...
#   [PSCustomObject]@{ Algorithm = "Honeycomb";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo honeycomb" } #Algo broken
    [PSCustomObject]@{ Algorithm = "JeongHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo glt-jeonghash" } #Trex-v0.18.6 is fastest
#   [PSCustomObject]@{ Algorithm = "KawPoW";      Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3; Command = " --algo kawpow" } #NBMiner-v33.3 is fastest
...
#   [PSCustomObject]@{ Algorithm = "MTP";         Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3; Command = " --algo mtp" } #Trex-v0.18.6 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "PawelHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo glt-pawelhash" } #Trex-v0.18.6 is fastest
...
#   [PSCustomObject]@{ Algorithm = "Sonoa";       Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo sonoa" } #Trex-v0.18.6 is fastest
...
#   [PSCustomObject]@{ Algorithm = "X16r";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x16r" } #Trex-v0.18.6 is fastest
    [PSCustomObject]@{ Algorithm = "X16rt";       Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x16rt" }
#   [PSCustomObject]@{ Algorithm = "X16rv2";      Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x16rv2" } #Trex-v0.18.6 is fastest
#   [PSCustomObject]@{ Algorithm = "X16s";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x16s" } #Trex-v0.18.6 is fastest
...
#   [PSCustomObject]@{ Algorithm = "X21s";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x21s" } #Trex-v0.18.6 is fastest
#   [PSCustomObject]@{ Algorithm = "X22i";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x22i" } #Trex-v0.18.6 is fastest
