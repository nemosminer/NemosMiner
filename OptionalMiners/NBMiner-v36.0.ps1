...
#   [PSCustomObject]@{ Algorithm = "Octopus";       Type = "NVIDIA"; Fee = 0.03;   MinMemGB = 5.0; MinMemGBWin10 = 5.0;  MinComputeCapability = 6.1; Command = " -mt 1 --algo octopus --fee 1" } # Trex-v0.19.5 is fastest
)
