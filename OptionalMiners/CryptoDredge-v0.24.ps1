...
$Uri = "https://github.com/technobyl/CryptoDredge/releases/download/v0.24.0/CryptoDredge_0.24.0_cuda_10.2_windows.zip"
$DeviceEnumerator = "Type_Vendor_Index"

$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "Allium";               Fee = 0.01; MinMemGB = 2; Command = " --algo=allium --intensity 8" }
   [PSCustomObject]@{ Algorithm = "Argon2d250";           Fee = 0.01; MinMemGB = 2; Command = " --algo=argon2d250 --intensity 8" } # No pool
   ...
   [PSCustomObject]@{ Algorithm = "Chukwa";               Fee = 0.01; MinMemGB = 2; Command = " --algo=chukwa --intensity 8" } # No pool
   [PSCustomObject]@{ Algorithm = "CryptonightXeq";       Fee = 0.01; MinMemGB = 2; Command = " --algo=cngpu --intensity 8" } # CryptonightGPU (XEQ Zergpool)
   [PSCustomObject]@{ Algorithm = "CryptonightHeavyTube"; Fee = 0.01; MinMemGB = 2; Command = " --algo=cnsaber --intensity 8" } # No pool
   [PSCustomObject]@{ Algorithm = "CryptonightCcx";       Fee = 0.01; MinMemGB = 2; Command = " --algo=cnconceal --intensity 8" } # No pool
   [PSCustomObject]@{ Algorithm = "CryptonightHalf";      Fee = 0.01; MinMemGB = 2; Command = " --algo=cnfast2 --intensity 8" } # No pool
   [PSCustomObject]@{ Algorithm = "CryptonightXhv";       Fee = 0.01; MinMemGB = 2; Command = " --algo=cnhaven --intensity 8" } # No pool
   ...
   [PSCustomObject]@{ Algorithm = "Cuckaroo29";           Fee = 0.01; MinMemGB = 6; Command = " --algo cuckaroo29 --intensity 5" }
   ...
   [PSCustomObject]@{ Algorithm = "Lux";                  Fee = 0.01; MinMemGB = 2; Command = " --algo=phi2 --intensity 8" } # No pool
   [PSCustomObject]@{ Algorithm = "Lyra2vc0ban";          Fee = 0.01; MinMemGB = 2; Command = " --algo=lyra2vc0ban --intensity 8" } # No pool
    [PSCustomObject]@{ Algorithm = "Lyra2zz ";             Fee = 0.01; MinMemGB = 2; Command = " --algo=lyra2zz --intensity 8" } # No pool
    [PSCustomObject]@{ Algorithm = "MTP";                  Fee = 0.02; MinMemGB = 5; Command = " --algo=mtp --intensity 8" }
   [PSCustomObject]@{ Algorithm = "MTPTcr";               Fee = 0.02; MinMemGB = 5; Command = " --algo=mtp-tcr --intensity 8" } #No pool
