...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "Equihash1445";  Type = "AMD"; Fee = 0.01;  MinMemGB = 3.0; MinerSet = 1; WarmupTimes = @(20, 20); Arguments = " --coin AUTO144_5" } # GMiner-v2.64 is fastest, but des not support Navi
    ...
    [PSCustomObject]@{ Algorithm = "BeamV3";        Type = "NVIDIA"; Fee = 0.01;  MinMemGB = 6.0; MinerSet = 1; WarmupTimes = @(0, 0);   Arguments = " --algo BEAM-III" } # NBMiner-v39.0 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "Equihash1445";  Type = "NVIDIA"; Fee = 0.01;  MinMemGB = 3.0; MinerSet = 1; WarmupTimes = @(20, 20); Arguments = " --coin AUTO144_5" } # MiniZ-v1.8y3 is fastest, but has 2% miner fee
