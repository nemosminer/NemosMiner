...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "CuckarooD29";   Type = "AMD"; Fee = 0.01;  MinMemGB = 4.0; MinerSet = 1; Arguments = " --algo C29D" } # TeamRed-v0.7.22 is fastest, keep enabled because TeamRed does not support algo on Navi
