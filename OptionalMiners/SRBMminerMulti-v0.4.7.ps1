...
#   [PSCustomObject]@{ Algorithm = "Rainforestv2"  ; MinMemGb = 1; Fee = 0.0085; Type = @("CPU", "AMD") ; Command = " --algorithm rainforestv2" } #No pool
...
#   [PSCustomObject]@{ Algorithm = "Yespower2b"    ; MinMemGb = 1; Fee = 0.0085; Type = @("CPU")        ; Command = " --algorithm yespower2b" } #No pool
#   [PSCustomObject]@{ Algorithm = "YespowerItc"   ; MinMemGb = 1; Fee = 0     ; Type = @("CPU")        ; Command = " --algorithm yespoweritc" } #No pool
#   [PSCustomObject]@{ Algorithm = "Yespowerlitb"  ; MinMemGb = 1; Fee = 0.0085; Type = @("CPU")        ; Command = " --algorithm yespowerlitb" } #No pool
#   [PSCustomObject]@{ Algorithm = "Yespowerltncg" ; MinMemGb = 1; Fee = 0.0085; Type = @("CPU")        ; Command = " --algorithm yespowerltncg" } #No pool
    [PSCustomObject]@{ Algorithm = "YespowerR16"   ; MinMemGb = 1; Fee = 0.0085; Type = @("CPU")        ; Command = " --algorithm yespowerr16" }
#   [PSCustomObject]@{ Algorithm = "YespowerSugar" ; MinMemGb = 1; Fee = 0.0085; Type = @("CPU")        ; Command = " --algorithm yespowersugar" } #No pool
#   [PSCustomObject]@{ Algorithm = "YespowerUrx"   ; MinMemGb = 1; Fee = 0;      Type = @("CPU")        ; Command = " --algorithm yespowerurx" } #No pool
)
