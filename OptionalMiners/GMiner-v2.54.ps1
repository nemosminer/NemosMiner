...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "EtcHash";      Fee = 0.0065; MinMemGB = 3.0; Type = "AMD"; MinerSet = 0; WarmupTime = 30; Arguments = " --algo etchash --cuda 0 --opencl 1" } # PhoenixMiner-v5.6c may be faster, but I see lower speed at the pool
    [PSCustomObject]@{ Algorithm = "Ethash";       Fee = 0.0065; MinMemGB = 4.0; Type = "AMD"; MinerSet = 0; WarmupTime = 30; Arguments = " --algo ethash --cuda 0 --opencl 1" } # PhoenixMiner-v5.6c may be faster, but I see lower speed at the pool
    [PSCustomObject]@{ Algorithm = "EthashLowMem"; Fee = 0.0065; MinMemGB = 3.0; Type = "AMD"; MinerSet = 0; WarmupTime = 30; Arguments = " --algo ethash --cuda 0 --opencl 1" } # PhoenixMiner-v5.6c may be faster, but I see lower speed at the pool
    ...
    [PSCustomObject]@{ Algorithm = "EtcHash";       Fee = 0.0065; MinMemGB = 3.0; Type = "NVIDIA"; Tuning = " --mt 2"; MinerSet = 0; WarmupTime = 30; Arguments = " --algo etchash --cuda 1 --opencl 0" } # PhoenixMiner-v5.6c may be faster, but I see lower speed at the pool
    [PSCustomObject]@{ Algorithm = "Ethash";        Fee = 0.0065; MinMemGB = 4.0; Type = "NVIDIA"; Tuning = " --mt 2"; MinerSet = 2; WarmupTime = 30; Arguments = " --algo ethash --cuda 1 --opencl 0" } # PhoenixMiner-v5.6c may be faster, but I see lower speed at the pool
