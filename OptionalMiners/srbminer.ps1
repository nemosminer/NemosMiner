...
$Path = ".\Bin\cpu-SRBMiner-Multi-0-3-9/SRBMiner-MULTI.exe"
$Uri = "https://github.com/doktor83/SRBMiner-Multi/releases/download/0.3.9/SRBMiner-Multi-0-3-9-win64.zip"
