...
$Path = ".\Bin\cpu-SRBMiner-Multi-0-3-2/SRBMiner-MULTI.exe"
$Uri = "https://github.com/doktor83/SRBMiner-Multi/releases/download/0.3.2/SRBMiner-Multi-0-3-2-win64.zip"
