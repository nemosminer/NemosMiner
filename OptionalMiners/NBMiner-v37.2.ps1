...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "Ethash";       Type = "AMD"; Fee = 0.01; MinMemGB = 4.0; MinMemGBWin10 = 4.0; MinerSet = 1; WarmupTime = 45; Arguments = " --algo ethash" } # PhoenixMiner-v5.5c may be faster, but I see lower speed at the pool
    ...
    [PSCustomObject]@{ Algorithm = "Ethash";       Type = "NVIDIA"; Fee = 0.01; MinMemGB = 4.0; MinMemGBWin10 = 4.0;  MinComputeCapability = 6.0; MinerSet = 1; WarmupTime = 45; Arguments = " -mt 1 --algo ethash" } # PhoenixMiner-v5.5c may be faster, but I see lower speed at the pool
