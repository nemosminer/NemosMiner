...
$Uri = "https://github.com/develsoftware/GMinerBetaRelease/releases/download/2.51/gminer_2_51_beta_windows64.zip"
...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    # [PSCustomObject]@{ Algorithm = "Equihash1445"; Fee = 0.02;   MinMemGB = 1.8; Type = "AMD"; MinerSet = 1; Arguments = " --algo equihash144_5 --pers auto --cuda 0 --opencl 1" } # lolMiner-v1.25 is fastest
    # [PSCustomObject]@{ Algorithm = "Equihash1927"; Fee = 0.02;   MinMemGB = 2.8; Type = "AMD"; MinerSet = 1; Arguments = " --algo equihash192_7 --pers auto --cuda 0 --opencl 1" } # lolMiner-v1.25 is fastest
    ...
    # [PSCustomObject]@{ Algorithm = "Cuckatoo31";    Fee = 0.02;   MinMemGB = 7.6; Type = "NVIDIA"; Tuning = " --mt 2"; MinerSet = 0; Arguments = " --algo cuckatoo31 --cuda 1 --opencl 0" }
    ...
    [PSCustomObject]@{ Algorithm = "Cuckoo29";      Fee = 0.02;   MinMemGB = 4.0; Type = "NVIDIA"; Tuning = " --mt 2"; MinerSet = 0; Arguments = " --algo cuckoo29 --cuda 1 --opencl 0" } # Broken in 2.50 (https://github.com/develsoftware/GMinerRelease/issues/199)
    ...
    # [PSCustomObject]@{ Algorithm = "KawPoW";        Fee = 0.01;   MinMemGB = 4.0; Type = "NVIDIA"; Tuning = " --mt 2"; MinerSet = 1; Arguments = " --algo kawpow --cuda 1 --opencl 0" } # XmRig-v6.10.0 is almost as fast but has no fee
)
