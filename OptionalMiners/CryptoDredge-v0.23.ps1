...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "Argon2d500";           Fee = 0.01; MinMemGB = 2; Command = " --algo=argon2d-dyn --intensity 6" }
...
#   [PSCustomObject]@{ Algorithm = "BCD";                  Fee = 0.01; MinMemGB = 1; Command = " --algo bcd" } #Profit close to 0
    ...
    [PSCustomObject]@{ Algorithm = "CryptonightXhv";       Fee = 0.01; MinMemGB = 2; Command = " --algo=cnhaven --intensity 8" }
...
#   [PSCustomObject]@{ Algorithm = "CuckooD29";            Fee = 0.01; MinMemGB = 3; Command = " --algo aeternity" } #reported API value (unit kH/s) is too small
#   [PSCustomObject]@{ Algorithm = "Cuckaroo29";           Fee = 0.01; MinMemGB = 6; Command = " --algo cuckaroo29 --intensity 5" } #reported API value (unit kH/s) is too small
