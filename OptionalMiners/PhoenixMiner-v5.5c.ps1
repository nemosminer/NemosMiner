...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = @("EtcHash");            Type = "AMD"; Fee = @(0.0065);   MinerSet = 1; Tuning = " -mi 12"; Arguments = " -amd -eres 1 -coin ETC" } # GMiner-v2.47 is just as fast, PhoenixMiner-v5.4c is maybe faster, bit I see lower sppeed at the pool
    ...
    [PSCustomObject]@{ Algorithm = @("Ethash");             Type = "AMD"; Fee = @(0.0065);   MinerSet = 1; Tuning = " -mi 12"; Arguments = " -amd -eres 1" } # GMiner-v2.47 is just as fast, PhoenixMiner-v5.4c is maybe faster, bit I see lower sppeed at the pool
    ...
    [PSCustomObject]@{ Algorithm = @("EtcHash");            Type = "NVIDIA"; Fee = @(0.0065);   MinerSet = 1; Tuning = " -mi 12 -vmt1 15 -vmt2 12 -vmt3 0 -vmr 15 -mcdag 1"; Arguments = " -nvidia -eres 1 -coin ETC" } # GMiner-v2.47 is just as fast, PhoenixMiner-v5.4c is maybe faster, bit I see lower sppeed at the pool
    ...
    [PSCustomObject]@{ Algorithm = @("Ethash");             Type = "NVIDIA"; Fee = @(0.0065);   MinerSet = 1; Tuning = " -mi 12 -vmt1 15 -vmt2 12 -vmt3 0 -vmr 15 -mcdag 1"; Arguments = " -nvidia -eres 1" } # GMiner-v2.47 is just as fast, PhoenixMiner-v5.4c is maybe faster, bit I see lower sppeed at the pool
