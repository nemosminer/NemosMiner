...
$Path = ".\Bin\$($Name)\nanominer.exe"
$Uri = "https://github.com/nanopool/nanominer/releases/download/v3.2.2/nanominer-windows-3.2.2.zip"
...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";     Type = "NVIDIA"; Fee = 0.01; MinMemGB = 3; MinerSet = 1; Coin= "Kawpow" } # Trex-v0.19.11 is fastest
    ...
    $Devices | Select-Object Type, Model -Unique | ForEach-Object { 
        ...
        If ($SelectedDevices = @($Devices | Where-Object Type -EQ $_.Type | Where-Object Model -EQ $_.Model)) { 
            ...
            $AlgorithmDefinitions | Where-Object Type -EQ $_.Type | ForEach-Object { 
                ...
                ElseIf ($_.Algorithm -eq "Octopus") { $WaitForData = 30 } # Seconds, additional wait time until first data sample
