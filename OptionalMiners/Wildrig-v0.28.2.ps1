...
#   [PSCustomObject]@{ Algorithm = "Lyra2RE3";    Type = "AMD"; Fee = @(0.01); MinMemGB = 2; Command = " --algo lyra2v3" } # TeamRed-v0.7.21 is fastest
...
#   [PSCustomObject]@{ Algorithm = "MTP";         Type = "AMD"; Fee = @(0.01); MinMemGB = 3; Command = " --algo mtp" } # TeamRed-v0.7.21 is fastest
...
#   [PSCustomObject]@{ Algorithm = "X16r";        Type = "AMD"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x16r" } # TeamRed-v0.7.21 is fastest
    [PSCustomObject]@{ Algorithm = "X16rt";       Type = "AMD"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x16rt" }
#   [PSCustomObject]@{ Algorithm = "X16rv2";      Type = "AMD"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x16rv2" } # TeamRed-v0.7.21 is fastest
...
#   [PSCustomObject]@{ Algorithm = "X21s";        Type = "AMD"; Fee = @(0.01); MinMemGB = 2; Command = " --algo x21s" } # TeamRed-v0.7.21 is fastest
