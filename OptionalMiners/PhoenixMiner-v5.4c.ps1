...
$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = @("EtcHash");            Type = "AMD"; Fee = @(0.0065);   MinMemGB = 3.9; Command = " -amd -eres 1 -mi 12 -coin ETC" } # GMiner-v2.41 is just as fast, PhoenixMiner-v5.4c is maybe faster, bit I see lower sppeed at the pool
    [PSCustomObject]@{ Algorithm = @("Ethash");             Type = "AMD"; Fee = @(0.0065);   MinMemGB = 3.9; Command = " -amd -eres 1 -mi 12" } # GMiner-v2.41 is just as fast, PhoenixMiner-v5.4c is maybe faster, bit I see lower sppeed at the pool
...
#   [PSCustomObject]@{ Algorithm = @("EtcHash");            Type = "NVIDIA"; Fee = @(0.0065);   MinMemGB = 4.0; Command = " -nvidia -eres 1 -mi 12 -vmt1 15 -vmt2 12 -vmt3 0 -vmr 15 -coin ETC" } # GMiner-v2.41 is just as fast, PhoenixMiner-v5.4c is maybe faster, bit I see lower sppeed at the pool
#   [PSCustomObject]@{ Algorithm = @("Ethash");             Type = "NVIDIA"; Fee = @(0.0065);   MinMemGB = 4.0; Command = " -nvidia -eres 1 -mi 12 -vmt1 15 -vmt2 12 -vmt3 0 -vmr 15" } # GMiner-v2.41 is just as fast, PhoenixMiner-v5.4c is maybe faster, bit I see lower sppeed at the pool
...
#   [PSCustomObject]@{ Algorithm = @("UbqHash");            Type = "NVIDIA"; Fee = @(0.0065);   MinMemGB = 4.0; Command = " -nvidia -eres 1 -mi 12 -vmt1 15 -vmt2 12 -vmt3 0 -vmr 15 -coin UBQ" } # TTMiner-v5.0.3 is fastest
)
