...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "EtcHash";      Fee = 0.01; MinMemGB = 3; MinerSet = 1; WarmupTime = 45; Arguments = " --algo etchash --intensity 25" } # GMiner-v2.54 is fastest
    [PSCustomObject]@{ Algorithm = "Ethash";       Fee = 0.01; MinMemGB = 5; MinerSet = 1; WarmupTime = 45; Arguments = " --algo ethash --intensity 25" } # GMiner-v2.54 is fastest
    [PSCustomObject]@{ Algorithm = "EthashLowMem"; Fee = 0.01; MinMemGB = 3; MinerSet = 1; WarmupTime = 45; Arguments = " --algo ethash --intensity 25" } # TTMiner-v5.0.3 is fastest
