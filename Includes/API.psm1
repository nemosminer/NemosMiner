        ...
        { 
            ...
            While ($Server.IsListening) { 
                ...
                Switch ($Path) { 
                    ...
                    "/miners/available" { 
                        $Data = ConvertTo-Json -Depth 4 @($Variables.Miners | Where-Object Available -EQ $true | Select-Object -Property * -ExcludeProperty Data, DataReaderJob, Devices, Process | Sort-Object Name)
                        Break
                    }
                    "/miners/best" { 
