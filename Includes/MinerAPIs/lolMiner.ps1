...
Class lolMiner : Miner { 
    [Object]GetMinerData () { 
        ...
        Switch ($Data.Algorithms[0].Performance_Unit) { 
            "kh/s"  { $HashRate_Unit = [Math]::Pow(10,3); Break }
            "Mh/s"  { $HashRate_Unit = [Math]::Pow(10,6); Break }
            "GH/s"  { $HashRate_Unit = [Math]::Pow(10,9); Break }
            "TH/s"  { $HashRate_Unit = [Math]::Pow(10,12); Break }
            "PH/s"  { $HashRate_Unit = [Math]::Pow(10,15); Break }
            "EH/s"  { $HashRate_Unit = [Math]::Pow(10,18); Break }
            "ZH/s"  { $HashRate_Unit = [Math]::Pow(10,21); Break }
            "YH/s"  { $HashRate_Unit = [Math]::Pow(10,24); Break }
