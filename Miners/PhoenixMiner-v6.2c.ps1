...
$Algorithms = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = @("EtcHash");                 Type = "AMD"; Fee = @(0.0065);   MinMemGB = $Pools."EtcHash".DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 1; Tuning = " -mi 12 -straps 1"; WarmupTimes = @(45, 0); Arguments = " -amd -eres 1 -coin ETC" } # GMiner-v2.93 is just as fast, PhoenixMiner-v6.2c is maybe faster, but I see lower speed at the pool
    ...
    [PSCustomObject]@{ Algorithm = @("Ethash");                  Type = "AMD"; Fee = @(0.0065);   MinMemGB = $Pools."Ethash".DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 1; Tuning = " -mi 12 -straps 1"; WarmupTimes = @(45, 0); Arguments = " -amd -eres 1 -coin ETH" } # GMiner-v2.93 is just as fast, PhoenixMiner-v6.2c is maybe faster, but I see lower speed at the pool
    ...
    [PSCustomObject]@{ Algorithm = @("EthashLowMem");            Type = "AMD"; Fee = @(0.0065);   MinMemGB = $Pools."EthashLowMem".DAGSizeGB; MemReserveGB = 0.42; MinerSet = 1; Tuning = " -mi 12 -straps 1"; WarmupTimes = @(45, 0); Arguments = " -amd -eres 1 -coin ETH" } # GMiner-v2.93 is just as fast, PhoenixMiner-v6.2c is maybe faster, but I see lower speed at the pool
