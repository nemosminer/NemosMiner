...
$Path = ".\Bin\NVIDIA-Ethminer018a2\ethminer.exe"
$Uri = "https://github.com/ethereum-mining/ethminer/releases/download/v0.18.0-alpha.2/ethminer-0.18.0-alpha.2-cuda10.0-windows-amd64.zip"
