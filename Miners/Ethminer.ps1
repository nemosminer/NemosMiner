...
$Path = ".\Bin\NVIDIA-Ethminer018cuda10\ethminer.exe"
$Uri = "https://github.com/ethereum-mining/ethminer/releases/download/v0.18.0-alpha.0/ethminer-0.18.0-alpha.0-cuda10.0-windows-amd64.zip"
