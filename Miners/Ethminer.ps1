...
$Path = ".\Bin\NVIDIA-Ethminer018a1\ethminer.exe"
$Uri = "https://github.com/ethereum-mining/ethminer/releases/download/v0.18.0-alpha.1/ethminer-0.18.0-alpha.1-cuda10.0-windows-amd64.zip"
