...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "AMD"; MinMemGB = 3;    MinerSet = 2; Arguments = " --algo kawpow" } # NBMiner-v37.1 is fastest, but has 2% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "NVIDIA"; MinMemGB = 3;    MinerSet = 0; Arguments = " --algo kawpow" } # TRex-v0.19.14  is fastest, but has 1% miner fee
