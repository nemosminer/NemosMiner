...
#    [PSCustomObject]@{ Algorithm = "Honeycomb";   Type = "AMD"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo honeycomb" } # Algo broken, last working version is 0.17.6
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";      Type = "AMD"; Fee = @(0.01); MinMemGB = 3; MinerSet = 1; WarmupTimes = @(45, 0); Arguments = " --algo kawpow" } # TeamRed-v0.8.6 is fastest on Navi
    [PSCustomObject]@{ Algorithm = "Lyra2RE3";    Type = "AMD"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo lyra2v3" } # TeamRed-v0.8.6 is fastest
    [PSCustomObject]@{ Algorithm = "Lyra2TDC";    Type = "AMD"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo lyra2tdc" }
    [PSCustomObject]@{ Algorithm = "MegaBtx";     Type = "AMD"; Fee = @(0.02); MinMemGB = 1; MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo megabtx" }
    ...
    [PSCustomObject]@{ Algorithm = "MTP";         Type = "AMD"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo mtp" } # TeamRed-v0.8.6 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X16r";        Type = "AMD"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x16r" } # TeamRed-v0.8.6 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X21s";        Type = "AMD"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x21s" } # TeamRed-v0.8.6 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "HeavyHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo heavyhash" }
    [PSCustomObject]@{ Algorithm = "Hex";         Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo hex" }
    [PSCustomObject]@{ Algorithm = "Hmq1725";     Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo hmq1725" } # CryptoDredge-v0.26.0 is fastest
#    [PSCustomObject]@{ Algorithm = "Honeycomb";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo honeycomb" } # Algo broken, last working version is 0.17.6
    [PSCustomObject]@{ Algorithm = "JeongHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo glt-jeonghash" } # Trex-v0.24.8 is fastest
    [PSCustomObject]@{ Algorithm = "KawPoW";      Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3; MinerSet = 1; WarmupTimes = @(45, 0); Arguments = " --algo kawpow" } # NBMiner-v39.5 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "MegaBtx";     Type = "NVIDIA"; Fee = @(0.02); MinMemGB = 1; MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo megabtx" }
    ...
    [PSCustomObject]@{ Algorithm = "MTP";         Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo mtp" } # Trex-v0.24.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "PawelHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 0; WarmupTimes = @(45, 0); Arguments = " --algo glt-pawelhash" } # Trex-v0.24.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "Sonoa";       Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo sonoa" } # Trex-v0.24.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X16r";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(45, 0); Arguments = " --algo x16r" } # Trex-v0.24.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X16s";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x16s" } # Trex-v0.24.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X21s";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2; MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x21s" } # Trex-v0.24.8 is fastest
    # [PSCustomObject]@{ Algorithm = "X22i";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3; MinerSet = 1; WarmupTimes = @(60, 15); Arguments = " --algo x22i" } # No results; Trex-v0.24.8 is fastest
        ...
        $Algorithms | Where-Object Type -EQ $_.Type | ForEach-Object { 
            ...
            If ($AvailableMiner_Devices = $Miner_Devices | Where-Object { $_.OpenCL.GlobalMemSize / 0.99GB -ge $MinMemGB }) { 
                ...
                [PSCustomObject]@{ 
                    ...
                    Type       = $_.Type
                    Path       = $Path
                    Arguments  = ("$($_.Arguments) --api-port=$($MinerAPIPort) --url=$($Pools.($_.Algorithm).Host):$($Pools.($_.Algorithm).Port) --user=$($Pools.($_.Algorithm).User) --pass=$($Pools.($_.Algorithm).Pass) --multiple-instance --opencl-threads auto --opencl-launch auto --opencl-platforms=$($AvailableMiner_Devices.PlatformId | Sort-Object -Unique) --opencl-devices=$(($AvailableMiner_Devices.$DeviceEnumerator | Sort-Object -Unique | ForEach-Object { '{0:x}' -f $_ }) -join ',')" -replace "\s+", " ").trim()
