...
If (-not ($Devices = $Variables.EnabledDevices.Where({ $_.Type -in @("AMD", "INTEL") -or $_.OpenCL.ComputeCapability -ge "5.0"} ))) { Return }

$URI = "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.79/lolMiner_v1.79_Win64.zip"
...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "SHA512256d");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();                             ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "kHeavyHash");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = @("RDNA1");                      ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KASPADUAL" }
#   [PSCustomObject]@{ Algorithms = @("Ethash", "SHA512256d");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();                             EExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
  [PSCustomObject]@{ Algorithms = @("EthashB3");                   Type = "AMD"; Fee = @(0.01);       MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 70); ExcludeGPUArchitecture = @("GCN1", "GCN2", "GCN3", "GCN4"); ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1992
    ...
    # [PSCustomObject]@{ Algorithms = @("EthashB3", "KarlsenHash");    Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @("RDNA1");                    ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode KARLSENDUAL" }
    # [PSCustomObject]@{ Algorithms = @("EthashB3", "kHeavyHash");     Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @("RDNA1");                    ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode KASPADUAL" }
    # [PSCustomObject]@{ Algorithms = @("EthashB3", "SHA512256d");     Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @("RDNA1");                    ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode RXDDUAL" }
    ...
    [PSCustomObject]@{ Algorithms = @("KarlsenHash");                Type = "AMD"; Fee = @(0.0075);     MinMemGiB = 2.0;  Minerset = 1; WarmupTimes = @(60, 50); ExcludeGPUArchitecture = @();                             ExcludePools = @(@(), @()); Arguments = " --algo KARLSEN" }
#   [PSCustomObject]@{ Algorithms = @("kHeavyHash");                 Type = "AMD"; Fee = @(0.0075);     MinMemGiB = 2.0;  Minerset = 1; WarmupTimes = @(90, 50); ExcludeGPUArchitecture = @();                             ExcludePools = @(@(), @()); Arguments = " --algo KASPA" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1991
    ...
    [PSCustomObject]@{ Algorithms = @("UbqHash", "kHeavyHash");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = @("RDNA1");                      ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode KASPADUAL" }
#   [PSCustomObject]@{ Algorithms = @("UbqHash", "SHA512256d");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = @();                             ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
...
#   [PSCustomObject]@{ Algorithms = @("kHeavyHash");                 Type = "INTEL"; Fee = @(0.0075);     MinMemGiB = 2.0;  Minerset = 2; WarmupTimes = @(60, 50); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @()); Arguments = " --algo KASPA" } #  https://github.com/Lolliedieb/lolMiner-releases/issues/1991
    ...
    [PSCustomObject]@{ Algorithms = @("BeamV3");                     Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 3.0;  Minerset = 2; WarmupTimes = @(45, 50); ExcludeGPUArchitecture = @("Other");          ExcludePools = @(@(), @()); Arguments = " --algo BEAM-III" } # NBMiner-v42.3 is fastest
...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "SHA512256d");      Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 1; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode RXDDUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "kHeavyHash");       Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(90, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KASPADUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1987
...
#   [PSCustomObject]@{ Algorithms = @("EthashB3", "kHeavyHash");     Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode KASPADUAL --maxdualimpact *" }
#   [PSCustomObject]@{ Algorithms = @("EthashB3", "SHA512256d");     Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode RXDDUAL --maxdualimpact *" }
    ...
    [PSCustomObject]@{ Algorithms = @("KarlsenHash");                Type = "NVIDIA"; Fee = @(0.0075);     MinMemGiB = 2.0;  MinerSet = 0; WarmupTimes = @(60, 50); ExcludeGPUArchitecture = @("Other");           ExcludePools = @(@(), @()); Arguments = " --algo KARLSEN" }
#   [PSCustomObject]@{ Algorithms = @("kHeavyHash");                 Type = "NVIDIA"; Fee = @(0.0075);     MinMemGiB = 2.0;  MinerSet = 0; WarmupTimes = @(60, 50); ExcludeGPUArchitecture = @("Other", "Pascal"); ExcludePools = @(@(), @()); Arguments = " --algo KASPA" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1991
...
#   [PSCustomObject]@{ Algorithms = @("UbqHash", "SHA512256d");      Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode RXDDUAL --maxdualimpact *" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
    [PSCustomObject]@{ Algorithms = @("SHA512256d");                 Type = "NVIDIA"; Fee = @(0.0075);     MinMemGiB = 1.00; Minerset = 2; WarmupTimes = @(60, 70); ExcludeGPUArchitecture = @("Other");           ExcludePools = @(@(), @()); Arguments = " --algo RADIANT" } 
)
