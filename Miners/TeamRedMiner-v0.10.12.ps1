...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithms = @("Autolykos2", "kHeavyHash");   Fee = @(0.025); MinMemGiB = 0.77; Minerset = 2; WarmupTimes = @(60, 15);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("GCN1", "GCN2");                            Arguments = " --algo=autolykos2" }
...
#   [PSCustomObject]@{ Algorithms = @("Cuckatoo31");                 Fee = @(0.025); MinMemGiB = 3.0;  Minerset = 3; WarmupTimes = @(60, 15);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("GCN1", "GCN2", "RDNA1", "RDNA2", "RDNA3"); Arguments = " --algo=cuckatoo31_grin" } # ASIC
    [PSCustomObject]@{ Algorithms = @("EtcHash");                    Fee = @(0.01);  MinMemGiB = 0.77; Minerset = 1; WarmupTimes = @(45, 65);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("GCN1", "GCN2");                            Arguments = " --algo=etchash" } # PhoenixMiner-v6.2c is fastest
...
#   [PSCustomObject]@{ Algorithms = @("EthashLowMem", "IronFish");   Fee = @(0.01);  MinMemGiB = 0.77; Minerset = 2; WarmupTimes = @(45, 65);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("GCN1", "GCN2");                            Arguments = " --algo=ethash" } # Pools with support at this time are Herominers, Flexpool and Kryptex
    [PSCustomObject]@{ Algorithms = @("FiroPow");                    Fee = @(0.02);  MinMemGiB = 0.77; MinerSet = 0; WarmupTimes = @(60, 65);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("GCN1", "GCN2", "RDNA3");                   Arguments = " --algo=firopow" } # Wildrig-v0.36.6bis fastest on Polaris
    ...
    [PSCustomObject]@{ Algorithms = @("KawPow");                     Fee = @(0.02);  MinMemGiB = 0.77; MinerSet = 0; WarmupTimes = @(60, 65);  ExcludePools = @(@("MiningPoolHub"), @()); ExcludeGPUArchitecture = @("GCN1", "GCN2", "RDNA3");                   Arguments = " --algo=kawpow" } # Wildrig-v0.36.6bis fastest on Polaris
