...
$Algorithms = @(
    ...
    # [PSCustomObject]@{ Algorithms = @("OctaSpace", "KarlsenHash");  Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; Minerset = 1; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @());        Arguments = " --algorithm octa+kheavyhash" }
    # [PSCustomObject]@{ Algorithms = @("OctaSpace", "SHA512256d");   Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; Minerset = 1; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @("ZPool")); Arguments = " --algorithm octa+sha512256d" }
    ...
    # [PSCustomObject]@{ Algorithms = @("PowBlocks", "Blake3");       Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @());        Arguments = " --algorithm powblocks+alephium" }
    # [PSCustomObject]@{ Algorithms = @("PowBlocks", "IronFish");     Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @());        Arguments = " --algorithm powblocks+ironfish" }
    # [PSCustomObject]@{ Algorithms = @("PowBlocks", "KarlsenHash");  Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @());        Arguments = " --algorithm powblocks+KarlsenHash" }
    # [PSCustomObject]@{ Algorithms = @("PowBlocks", "SHA512256d");   Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @("ZPool")); Arguments = " --algorithm powblocks+sha512256d" }
