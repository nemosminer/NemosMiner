...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithms = @("Autolykos2", "IronFish");     Fee = @(0.025); MinMemGiB = $MinerPools[0].Autolykos2.DAGSizeGiB + 0.77;   Minerset = 2; WarmupTimes = @(60, 15);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("CGN1", "CGN2");                            Arguments = " --algo=autolykos2" } # Pools with support at this time are Herominers, Flexpool and Kryptex
#   [PSCustomObject]@{ Algorithms = @("IronFish");                   Fee = @(0.025); MinMemGiB = 2.0;                                           Minerset = 2; WarmupTimes = @(60, 15);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("CGN1", "CGN2", "RDNA1", "RDNA2", "RDNA3"); Arguments = " --algo=ironfish" } # Pools with support at this time are Herominers, Flexpool and Kryptex
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "IronFish");         Fee = @(0.01);  MinMemGiB = $MinerPools[0].Ethash.DAGSizeGiB + 0.77;       Minerset = 2; WarmupTimes = @(60, 65);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("CGN1", "CGN2");                            Arguments = " --algo=ethash" } # Pools with support at this time are Herominers, Flexpool and Kryptex
...
#   [PSCustomObject]@{ Algorithms = @("EthashLowMem", "IronFish");   Fee = @(0.01);  MinMemGiB = $MinerPools[0].EthashLowMem.DAGSizeGiB + 0.77; Minerset = 2; WarmupTimes = @(45, 65);  ExcludePools = @(@(), @());                ExcludeGPUArchitecture = @("CGN1", "CGN2");                            Arguments = " --algo=ethash" } # Pools with support at this time are Herominers, Flexpool and Kryptex
