...
$Uri = "https://github.com/develsoftware/GMinerRelease/releases/download/2.81/gminer_2_81_windows64.zip"
...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "Equihash1445";  Fee = 0.02; MinMemGB = 1.8; Type = "AMD"; MinerSet = 1; WarmupTimes = @(30, 0); Arguments = " --algo equihash144_5 --pers auto --cuda 0 --opencl 1" } # lolMiner-v1.46a is fastest
    [PSCustomObject]@{ Algorithm = "Equihash2109";  Fee = 0.02; MinMemGB = 2.8; Type = "AMD"; MinerSet = 1; WarmupTimes = @(30, 0); Arguments = " --algo equihash210_9 --pers auto --cuda 0 --opencl 1" } # lolMiner-v1.46a is fastest
