...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "AMD"; MinMemGB = ($Pools."KawPoW".DAGSize + $1.5GB) / 1GB; MinerSet = 2; WarmupTimes = @(60, 15); Arguments = " --algo kawpow" } # NBMiner-v40.1 is fastest, but has 2% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "NVIDIA"; MinMemGB = ($Pools."KawPoW".DAGSize + $1.5GB) / 1GB; MinerSet = 0; WarmupTimes = @(60, 15); Arguments = " --algo kawpow" } # Trex-v0.25.12 is fastest, but has 1% miner fee
