...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "AMD"; MinMemGB = $Pools."KawPoW".DAGSizeGB; MemReserveGB = 0.03; MinerSet = 2; WarmupTimes = @(60, 15); Arguments = " --algo kawpow" } # NBMiner-v41.3 is fastest, but has 2% miner fee
