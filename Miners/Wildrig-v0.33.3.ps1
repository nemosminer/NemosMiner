...
$Uri = "https://github.com/andru-kun/wildrig-multi/releases/download/0.33.3/wildrig-multi-windows-0.33.3.7z"
...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";           Type = "AMD"; Fee = @(0.01); MinMemGB = $MinerPools[0].KawPoW.DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo kawpow" } # TeamRedMiner-v0.10.5.1 is fastest on Navi
    [PSCustomObject]@{ Algorithm = "Lyra2RE3";         Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo lyra2v3" } # TeamRedMiner-v0.10.5.1 is fastest
...
#   [PSCustomObject]@{ Algorithm = "Mike";             Type = "AMD"; Fee = @(0.05); MinMemGB = 1;                                    MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo mike" } # No hashrate in time
    ...
    [PSCustomObject]@{ Algorithm = "MTP";              Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo mtp" } # TeamRedMiner-v0.10.5.1 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "ProgPoWSero";      Type = "AMD"; Fee = @(0.01); MinMemGB = $MinerPools[0].ProgPoWSero.DAGSizeGB; MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo progpow-sero" }
...
#   [PSCustomObject]@{ Algorithm = "SHA256t";          Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo sha256t" } # Takes too long until it starts mining
    ...
    [PSCustomObject]@{ Algorithm = "SHA512256d";       Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo sha512256d" }
    ...
    [PSCustomObject]@{ Algorithm = "X16r";             Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x16r" } # TeamRedMiner-v0.10.5.1 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X21s";             Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x21s" } # TeamRedMiner-v0.10.5.1 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "JeongHash";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo glt-jeonghash --watchdog" } # Trex-v0.26.8 is fastest
    [PSCustomObject]@{ Algorithm = "KawPoW";           Type = "NVIDIA"; Fee = @(0.01); MinMemGB = $MinerPools[0].KawPoW.DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo kawpow --watchdog" } # NBMiner-v42.3 is fastest
...
#   [PSCustomObject]@{ Algorithm = "Mike";             Type = "NVIDIA"; Fee = @(0.05); MinMemGB = 1;                                    MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo mike --watchdog" } # No hashrate in time
    ...
    [PSCustomObject]@{ Algorithm = "MTP";              Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo mtp --watchdog" } # Trex-v0.26.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "PawelHash";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(45, 0);  Arguments = " --algo glt-pawelhash --watchdog" } # Trex-v0.26.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "ProgPoWSero";      Type = "NVIDIA"; Fee = @(0.01); MinMemGB = $MinerPools[0].ProgPoWSero.DAGSizeGB; MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo progpow-sero --watchdog" }
    ...
    [PSCustomObject]@{ Algorithm = "ProgPoWZ";         Type = "NVIDIA"; Fee = @(0.01); MinMemGB = $MinerPools[0].ProgPoWZ.DAGSizeGB;    MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo progpowz --watchdog" }
...
#   [PSCustomObject]@{ Algorithm = "SHA256t";          Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo sha256t --watchdog" } # Takes too long until it starts mining
    ...
    [PSCustomObject]@{ Algorithm = "SHA512256d";       Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo sha512256d --watchdog" }
    ...
    [PSCustomObject]@{ Algorithm = "Sonoa";            Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(45, 15); Arguments = " --algo sonoa --watchdog" } # Trex-v0.26.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X16r";             Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo x16r --watchdog" } # Trex-v0.26.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X16s";             Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x16s --watchdog" } # Trex-v0.26.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X21s";             Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x21s --watchdog" } # Trex-v0.26.8 is fastest
#   [PSCustomObject]@{ Algorithm = "X22i";             Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(60, 15); Arguments = " --algo x22i --watchdog" } # Algorithm is broken; Trex-v0.26.8 is fastest
