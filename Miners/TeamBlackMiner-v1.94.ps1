...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "KawPow");   Type = "AMD"; Fee = 0.005; MinMemGiB = 1.21 + $MinerPools[1].KawPow.DAGSizeGiB; ExcludePools = @(@("HiveOn"), @()); Minerset = 1; Tuning = ""; WarmupTimes = @(45, 45); Arguments = " --algo etc+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/376
    [PSCustomObject]@{ Algorithms = @("EtcHash", "VertHash"); Type = "AMD"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@("HiveOn"), @()); Minerset = 1; Tuning = ""; WarmupTimes = @(45, 45); Arguments = " --algo etc+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "KawPow");    Type = "AMD"; Fee = 0.005; MinMemGiB = 1.21 + $MinerPools[1].KawPow.DAGSizeGiB; ExcludePools = @(@("HiveOn"), @()); Minerset = 1; Tuning = ""; WarmupTimes = @(45, 45); Arguments = " --algo eth+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/376
    [PSCustomObject]@{ Algorithms = @("Ethash", "VertHash");  Type = "AMD"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@("HiveOn"), @()); Minerset = 1; Tuning = ""; WarmupTimes = @(45, 45); Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
#   [PSCustomObject]@{ Algorithms = @("EthashLowMem");        Type = "AMD"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@(), @());         Minerset = 2; Tuning = ""; WarmupTimes = @(45, 15); Arguments = " --algo ethash" } # TTMiner-v5.0.3 is fastest
...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "KawPow");   Type = "INTEL"; Fee = 0.005; MinMemGiB = 1.21 + $MinerPools[1].KawPow.DAGSizeGiB; ExcludePools = @(@("HiveOn"), @()); Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); Arguments = " --algo etc+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/376
    [PSCustomObject]@{ Algorithms = @("EtcHash", "VertHash"); Type = "INTEL"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@("HiveOn"), @()); Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); Arguments = " --algo etc+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "KawPow");    Type = "INTEL"; Fee = 0.005; MinMemGiB = 1.21 + $MinerPools[1].KawPow.DAGSizeGiB; ExcludePools = @(@("HiveOn"), @()); Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); Arguments = " --algo eth+rvn " } # https://github.com/sp-hash/TeamBlackMiner/issues/376
    [PSCustomObject]@{ Algorithms = @("Ethash", "VertHash");  Type = "INTEL"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@("HiveOn"), @()); Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
#   [PSCustomObject]@{ Algorithms = @("EthashLowMem");        Type = "INTEL"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@(), @());         Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 15); Arguments = " --algo ethash" }
...
#   [PSCustomObject]@{ Algorithms = @("EtcHash", "KawPow");   Type = "NVIDIA"; Fee = 0.005; MinMemGiB = 1.21 + $MinerPools[1].KawPow.DAGSizeGiB; ExcludePools = @(@("HiveOn"), @()); Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); Arguments = " --algo etc+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/376
    [PSCustomObject]@{ Algorithms = @("EtcHash", "VertHash"); Type = "NVIDIA"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@("HiveOn"), @()); Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); Arguments = " --algo etc+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "KawPow");    Type = "NVIDIA"; Fee = 0.005; MinMemGiB = 1.21 + $MinerPools[1].KawPow.DAGSizeGiB; ExcludePools = @(@("HiveOn"), @()); Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); Arguments = " --algo eth+rvn" }# https://github.com/sp-hash/TeamBlackMiner/issues/376
    [PSCustomObject]@{ Algorithms = @("Ethash", "VertHash");  Type = "NVIDIA"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@("HiveOn"), @()); Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
#   [PSCustomObject]@{ Algorithms = @("EthashLowMem");        Type = "NVIDIA"; Fee = 0.005; MinMemGiB = 1.21;                                    ExcludePools = @(@(), @());         Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 15); Arguments = " --algo ethash" } # TTMiner-v5.0.3 is fastest
    [PSCustomObject]@{ Algorithms = @("KawPow");              Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 1.21;                                    ExcludePools = @(@(), @());         Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(75, 45); Arguments = " --algo kawpow" }
