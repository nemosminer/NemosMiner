...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "NeoscryptXaya"; MinMemGB = 2; MinerSet = 0; WarmupTimes = @(0, 75); Arguments = " --algo neoscrypt-xaya --cpu-priority 4 --retries 1 --retry-pause 1 --intensity 21" }
)
