...
$Algorithms = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "NeoscryptXaya"; MinMemGB = 2; MinerSet = 0; WarmupTimes = @(120, 15); Arguments = " --algo neoscrypt-xaya --retries 1 --retry-pause 1 --intensity 21 --statsavg 5" }
)
