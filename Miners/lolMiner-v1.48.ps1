...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = @("EtcHash");                   Type = "AMD"; Fee = @(0.007);      MinMemGB = ($Pools."Etchash".DAGSize + 0.95GB) / 1GB;      MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETCHASH" } # Ethereum Classic, PhoenixMiner-v6.0c is faster
    [PSCustomObject]@{ Algorithm = @("EtcHash", "Blake3");         Type = "AMD"; Fee = @(0.01, 0.01); MinMemGB = ($Pools."Etchash".DAGSize + 0.95GB) / 1GB;      MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETCHASH --dualmode ALEPHDUAL" } # Ethereum Classic, PhoenixMiner-v6.0c is faster
    [PSCustomObject]@{ Algorithm = @("EtcHash", "SHA256ton");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGB = ($Pools."Etchash".DAGSize + 0.95GB) / 1GB;      MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETCHASH --dualmode TONDUAL" } # Ethereum Classic, PhoenixMiner-v6.0c is faster
    [PSCustomObject]@{ Algorithm = @("Ethash");                    Type = "AMD"; Fee = @(0.007);      MinMemGB = ($Pools."Ethash".DAGSize + 0.95GB) / 1GB;       MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETHASH" } # PhoenixMiner-v6.0c is faster
    ...
    [PSCustomObject]@{ Algorithm = @("EthashLowMem");              Type = "AMD"; Fee = @(0.007);      MinMemGB = ($Pools."EthashLowMem".DAGSize + 0.95GB) / 1GB; MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETHASH" } # PhoenixMiner-v6.0c is faster
    ...
    [PSCustomObject]@{ Algorithm = @("EtcHash");                   Type = "NVIDIA"; Fee = @(0.007);      MinMemGB = ($Pools."Etchash".DAGSize + 0.95GB) / 1GB;      MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETCHASH" } # Ethereum Classic, PhoenixMiner-v6.0c is faster
    [PSCustomObject]@{ Algorithm = @("EtcHash", "Blake3");         Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGB = ($Pools."Etchash".DAGSize + 0.95GB) / 1GB;      MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETCHASH --dualmode ALEPHDUAL" } # Ethereum Classic, PhoenixMiner-v6.0c is faster
    [PSCustomObject]@{ Algorithm = @("EtcHash", "SHA256ton");      Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGB = ($Pools."Etchash".DAGSize + 0.95GB) / 1GB;      MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETCHASH --dualmode TONDUAL" } # Ethereum Classic, PhoenixMiner-v6.0c is faster
    [PSCustomObject]@{ Algorithm = @("Ethash");                    Type = "NVIDIA"; Fee = @(0.007);      MinMemGB = ($Pools."Ethash".DAGSize + 0.95GB) / 1GB;       MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETHASH" } # PhoenixMiner-v6.0c is faster
    ...
    [PSCustomObject]@{ Algorithm = @("EthashLowMem");              Type = "NVIDIA"; Fee = @(0.007);      MinMemGB = ($Pools."EthashLowMem".DAGSize + 0.95GB) / 1GB; MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETHASH" } # PhoenixMiner-v6.0c is faster
    ...
    $Devices | Select-Object Type, Model -Unique | ForEach-Object { 
        ...
        $Algorithms | Where-Object Type -EQ $_.Type | ConvertTo-Json | ConvertFrom-Json | ForEach-Object { 
            ...
            If ($AvailableMiner_Devices = $Miner_Devices | Where-Object MemoryGB -ge $_.MinMemGB) { 
                ...
                $_.Arguments += " --user $($Pools.($_.Algorithm[0]).User) --pass $($Pools.($_.Algorithm[0]).pass)$(If ($Pools.($_.Algorithm[0]).BaseName -eq "ProHashing" -and $_.Algorithm[0] -eq "EthashLowMem") { ",l=$((($AvailableMiner_Devices.Memory | Measure-Object -Minimum).Minimum - 1.5GB) / 1GB)" })"
