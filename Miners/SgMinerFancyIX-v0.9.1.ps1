...
$Uri = "https://github.com/fancyIX/sgminer-phi2-branch/releases/download/0.9.1/sgminer-fancyIX-win64-0.9.1.zip"
$Name = "$(Get-Item $MyInvocation.MyCommand.Path | Select-Object -ExpandProperty BaseName)"
$Path = ".\Bin\$($Name)\sgminer.exe"
$DeviceEnumerator = "Type_Vendor_Index"

$Algorithms = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "0x10";          MinMemGB = 2; MinerSet = 0; WarmupTimes = @(45, 0); Arguments = " --scan-time 1 --gpu-threads 1 --worksize 256 --intensity 17 --kernel chainox" }
