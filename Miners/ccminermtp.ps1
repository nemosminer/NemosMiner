...
$Path = ".\Bin\NVIDIA-ccminermtp1122\ccminer.exe"
$Uri = "https://github.com/zcoinofficial/ccminer/releases/download/1.1.22/ccminer.exe"

$Commands = [PSCustomObject]@{
     "mtp" = " -i 20 -d $($Config.SelGPUCC)" #mtp
}
