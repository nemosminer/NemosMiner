...
$Commands = [PSCustomObject]@{
    #"mtp" = "" #mtp(disabled as alot of users still running 4gb rigs i have 8gb now.. requires 6gb min ram + large vm/swap fastest check pool speed over CD for 24-48hours + no dev fee)
}
