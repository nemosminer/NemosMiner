...
$Uri = "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.57/lolMiner_v1.57_Win64.zip"
...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = @("EtcHash", "Kaspa");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGB = $MinerPools[0].Etchash.DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETCHASH --dualmode KASPADUAL" }
    ...
    [PSCustomObject]@{ Algorithm = @("Ethash", "Kaspa");        Type = "AMD"; Fee = @(0.01, 0.01); MinMemGB = $MinerPools[0].Ethash.DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETHASH --dualmode KASPADUAL" }
    ...
    [PSCustomObject]@{ Algorithm = @("EthashLowMem", "Kaspa");  Type = "AMD"; Fee = @(0.01, 0.01); MinMemGB = $MinerPools[0].EthashLowMem.DAGSizeGB; MemReserveGB = 0.42; MinerSet = 2; WarmupTimes = @(45, 45); Arguments = " --algo ETHASH --dualmode KASPADUAL" }
    ...
    [PSCustomObject]@{ Algorithm = @("UbqHash", "Kaspa");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGB = $MinerPools[0].UbqHash.DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 2; WarmupTimes = @(60, 45); Arguments = " --algo UBQHASH --dualmode KASPADUAL" }
