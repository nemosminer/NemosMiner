...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = @("EtcHash");              Fee = @(0.01);  MinMemGB = 3.0; MinerSet = 1; WarmupTimes = @(45, 75); Arguments = " --algo=etchash" } # PhoenixMiner-v6.0c is fastest
    [PSCustomObject]@{ Algorithm = @("Ethash");               Fee = @(0.01);  MinMemGB = 5.0; MinerSet = 1; WarmupTimes = @(45, 75); Arguments = " --algo=ethash" } # PhoenixMiner-v6.0c is fastest
    [PSCustomObject]@{ Algorithm = @("Ethash", "SHA256ton");  Fee = @(0.01);  MinMemGB = 5.0; MinerSet = 0; WarmupTimes = @(45, 90); Arguments = " --algo=ethash" }
