...
#   [PSCustomObject]@{ Algorithm = "Sha256t";     Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo sha256t" } # Takes too long until it starts mining
    ...
    [PSCustomObject]@{ Algorithm = "VProgPoW";    Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo vprogpow" }
    ...
    [PSCustomObject]@{ Algorithm = "JeongHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo glt-jeonghash --watchdog" } # Trex-v0.26.4 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "MTP";         Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3;                         MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo mtp --watchdog" } # Trex-v0.26.4 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "PawelHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(45, 0);  Arguments = " --algo glt-pawelhash --watchdog" } # Trex-v0.26.4 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "ProgPoWSero"; Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo progpowsero --watchdog" }
    [PSCustomObject]@{ Algorithm = "ProgPoWVeil"; Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo progpowveil --watchdog" }
...
#   [PSCustomObject]@{ Algorithm = "Sha256t";     Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo sha256t --watchdog" } # Takes too long until it starts mining
    ...
    [PSCustomObject]@{ Algorithm = "Sonoa";       Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(45, 15); Arguments = " --algo sonoa --watchdog" } # Trex-v0.26.4 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "VProgPoW";    Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo vprogpow --watchdog" }
    ...
    [PSCustomObject]@{ Algorithm = "X16r";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo x16r --watchdog" } # Trex-v0.26.4 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X16s";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x16s --watchdog" } # Trex-v0.26.4 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X21s";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x21s --watchdog" } # Trex-v0.26.4 is fastest
#   [PSCustomObject]@{ Algorithm = "X22i";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                         MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(60, 15); Arguments = " --algo x22i --watchdog" } # Algorithm is broken; Trex-v0.26.4 is fastest
