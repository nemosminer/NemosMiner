...
$Uri = "https://github.com/Minerx117/miners/releases/download/MiniZ/miniZ_v2.0c3_win-x64.zip"
...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "Equihash1927";     Type = "AMD"; Fee = @(0.02);   MinMemGiB = 2.3;                                           MinerSet = 1; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @("CGN4", "RDNA1", "RDNA2"); Arguments = " --amd $(Get-EquihashCoinPers -Command "--pers " -Currency $MinerPools[0].Equihash1927.Currency -DefaultCommand "--par=192,7")" } #FPGA
    ...
    [PSCustomObject]@{ Algorithm = "Equihash965";      Type = "AMD"; Fee = @(0.02);   MinMemGiB = 2.0;                                           Minerset = 2; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @("CGN4", "RDNA1");          Arguments = " --amd --par=96,5 --smart-pers" }
