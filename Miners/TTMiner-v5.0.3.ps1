...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "Ethash";       MinMemGB = 4; MinerSet = 0; WarmupTime = 30; Arguments = " -algo ETHASH -intensity 15" } # PhoenixMiner-v5.6d may be faster, but I see lower speed at the pool
