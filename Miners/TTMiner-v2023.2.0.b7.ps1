...
$Uri = Switch ($Variables.DriverVersion.CUDA) { 
    { $_ -ge "11.0" } { "https://github.com/TrailingStop/TT-Miner-beta/releases/download/2023.2.0-beta7/TT-Miner-2023.2.0.b7.zip"; Break }
    Default           { Return }
}
...
#   [PSCustomObject]@{ Algorithm = "EthashLowMem";     Fee = 0.01; MinMemGiB = 0.81; Minerset = 2; WarmupTimes = @(60, 15);  ExcludeGPUArchitecture = @(); ExcludePool = @();              Arguments = " -a Ethash" }
    ...
    [PSCustomObject]@{ Algorithm = "ProgPowEpic";      Fee = 0.02; MinMemGiB = 0.82; Minerset = 2; WarmupTimes = @(60, 15);  ExcludeGPUArchitecture = @(); ExcludePool = @();              Arguments = " -c EPIC" }
