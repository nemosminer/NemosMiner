...
$AlgorithmDefinitions = [PSCustomObject[]]@(
   [PSCustomObject]@{ Algorithm = "KawPoW"; MinMemGB = 3; MinerSet = 2; WarmupTimes = @(0, 15); Arguments = "" } # XmRig-v6.16.2 is faster
)
