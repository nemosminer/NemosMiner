...
$Algorithms = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "BeamV3";       Type = "AMD"; Fee = 0.02;   MinMemGB = 4.0;                             MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); GPUArchitecture = @("RDNA2");                 Arguments = " --par=beam3 --pers=Beam-PoW --ocX" } # NBMiner-v42.2 is fastest
    [PSCustomObject]@{ Algorithm = "Equihash1254"; Type = "AMD"; Fee = 0.02;   MinMemGB = 3.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=125,4 --smart-pers --ocX" }
    [PSCustomObject]@{ Algorithm = "Equihash1445"; Type = "AMD"; Fee = 0.02;   MinMemGB = 2.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=144,5 --smart-pers --ocX" }
    [PSCustomObject]@{ Algorithm = "Equihash1505"; Type = "AMD"; Fee = 0.02;   MinMemGB = 2.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=150,5 --smart-pers --ocX" }
    [PSCustomObject]@{ Algorithm = "Equihash1927"; Type = "AMD"; Fee = 0.02;   MinMemGB = 2.3;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("RDNA2");                 Arguments = " --par=192,7 --smart-pers --ocX" }
    [PSCustomObject]@{ Algorithm = "Equihash2109"; Type = "AMD"; Fee = 0.02;   MinMemGB = 2.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=210,9 --smart-pers --ocX" }
    [PSCustomObject]@{ Algorithm = "Equihash965";  Type = "AMD"; Fee = 0.02;   MinMemGB = 2.0;                             MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(30, 15); GPUArchitecture = @("RDNA2");                 Arguments = " --par=96,5 --smart-pers --ocX" }
    [PSCustomObject]@{ Algorithm = "EquihashBTG";  Type = "AMD"; Fee = 0.02;   MinMemGB = 3.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=144,5 --pers BgoldPoW --ocX" }
    [PSCustomObject]@{ Algorithm = "EquihashZCL";  Type = "AMD"; Fee = 0.02;   MinMemGB = 3.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("RDNA2");                 Arguments = " --par=192,7 --pers ZcashPoW --ocX" }
    [PSCustomObject]@{ Algorithm = "EtcHash";      Type = "AMD"; Fee = 0.0075; MinMemGB = $Pools."EtcHash".DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 15); GPUArchitecture = @("CGN4", "RDNA2");         Arguments = " --par=EtcHash --dag-fix  --ocX" }
    [PSCustomObject]@{ Algorithm = "Ethash";       Type = "AMD"; Fee = 0.0075; MinMemGB = $Pools."Ethash".DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 15); GPUArchitecture = @("CGN4", "RDNA2");         Arguments = " --par=Ethash --dag-fix --ocX" }
    [PSCustomObject]@{ Algorithm = "EthashLowMem"; Type = "AMD"; Fee = 0.0075; MinMemGB = $Pools."EthashLowMem".DAGSizeGB; MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(45, 15); GPUArchitecture = @("CGN4", "RDNA2");         Arguments = " --par=Ethash --dag-fix --ocX" } # TTMiner-v5.0.3 is fastest
    [PSCustomObject]@{ Algorithm = "FiroPoW";      Type = "AMD"; Fee = 0.0075; MinMemGB = 5;                               MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(55, 45); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=ProgPow --pers=firo --ocX" }
    [PSCustomObject]@{ Algorithm = "KawPoW";       Type = "AMD"; Fee = 0.01;   MinMemGB = $Pools."KawPoW".DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 35); GPUArchitecture = @("RDNA2");                 Arguments = " --par=Kawpow --dag-fix --pers=RAVENCOINKAWPOW" }
    [PSCustomObject]@{ Algorithm = "Veil";         Type = "AMD"; Fee = 0.01;   MinMemGB = 8.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=ProgPow --pers=veil --ocX" }
    [PSCustomObject]@{ Algorithm = "Veriblock";    Type = "AMD"; Fee = 0.01;   MinMemGB = 8.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=ProgPowZ --pers=zano --ocX" }
    [PSCustomObject]@{ Algorithm = "Zano";         Type = "AMD"; Fee = 0.01;   MinMemGB = 2.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); GPUArchitecture = @("CGN4", "RDNA", "RDNA2"); Arguments = " --par=vProgPow --pers=VeriBlock --ocX" }
...
If ($Algorithms = $Algorithms | Where-Object MinerSet -LE $Config.MinerSet | Where-Object { $Pools.($_.Algorithm).Host }) { 
    ...
    $Devices | Select-Object Type, Model -Unique | ForEach-Object { 
        ...
        $Algorithms | Where-Object Type -EQ $_.Type | ConvertTo-Json | ConvertFrom-Json | ForEach-Object { 
            ...
            $GPUArchitecture = $_.GPUArchitecture

            If ($AvailableMiner_Devices = $Miner_Devices | Where-Object MemoryGB -ge ($_.MinMemGB + $_.MemReserveGB) | Where-Object { -not $GPUArchitecture -or $_.Architecture -in $GPUArchitecture }) { 
