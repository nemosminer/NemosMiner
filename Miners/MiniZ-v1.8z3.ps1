...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "Veil";         Type = "AMD"; Fee = 0.01;   MinMemGB = 8.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); ExcludeGPUArchitecture = @("CGN4", "RDNA"); Arguments = " --par=ProgPow --pers=veil" }
    [PSCustomObject]@{ Algorithm = "Veriblock";    Type = "AMD"; Fee = 0.01;   MinMemGB = 8.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); ExcludeGPUArchitecture = @("CGN4", "RDNA"); Arguments = " --par=ProgPowZ --pers=zano" }
    [PSCustomObject]@{ Algorithm = "Zano";         Type = "AMD"; Fee = 0.01;   MinMemGB = 2.0;                             MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); ExcludeGPUArchitecture = @("CGN4", "RDNA"); Arguments = " --par=vProgPow --pers=VeriBlock" }
