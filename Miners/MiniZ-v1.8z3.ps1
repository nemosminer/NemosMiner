...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "EtcHash";          Type = "AMD"; Fee = @(0.0075); MinMemGB = $Pools."EtcHash".DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @("CGN4", "RDNA"); Arguments = " --amd --par=EtcHash --dag-fix" }
    [PSCustomObject]@{ Algorithm = "Ethash";           Type = "AMD"; Fee = @(0.0075); MinMemGB = $Pools."Ethash".DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @("CGN4", "RDNA"); Arguments = " --amd --par=Ethash --dag-fix" }
    [PSCustomObject]@{ Algorithm = "EthashLowMem";     Type = "AMD"; Fee = @(0.0075); MinMemGB = $Pools."EthashLowMem".DAGSizeGB; MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @("CGN4", "RDNA"); Arguments = " --amd --par=Ethash --dag-fix" } # TTMiner-v5.0.3 is fastest
    [PSCustomObject]@{ Algorithm = "FiroPoW";          Type = "AMD"; Fee = @(0.0075); MinMemGB = $Pools."FiroPoW".DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(55, 45); ExcludeGPUArchitecture = @("CGN4", "RDNA"); Arguments = " --amd --pers=firo" }
    [PSCustomObject]@{ Algorithm = "KawPoW";           Type = "AMD"; Fee = @(0.01);   MinMemGB = $Pools."KawPoW".DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 35); ExcludeGPUArchitecture = @("CGN4", "RDNA"); Arguments = " --amd --par=Kawpow --dag-fix --pers=RAVENCOINKAWPOW" }
    ...
    [PSCustomObject]@{ Algorithm = "EtcHash";          Type = "NVIDIA"; Fee = @(0.0075); MinMemGB = $Pools."EtcHash".DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 15); Arguments = " --nvidia --par=EtcHash --dag-fix  --ocX" }
    [PSCustomObject]@{ Algorithm = "Ethash";           Type = "NVIDIA"; Fee = @(0.0075); MinMemGB = $Pools."Ethash".DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 15); Arguments = " --nvidia --par=Ethash --dag-fix --ocX" }
    [PSCustomObject]@{ Algorithm = "EthashLowMem";     Type = "NVIDIA"; Fee = @(0.0075); MinMemGB = $Pools."EthashLowMem".DAGSizeGB; MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(45, 15); Arguments = " --nvidia --par=Ethash --dag-fix --ocX" } # TTMiner-v5.0.3 is fastest
    [PSCustomObject]@{ Algorithm = "FiroPoW";          Type = "NVIDIA"; Fee = @(0.0075); MinMemGB = $Pools."FiroPoW".DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(55, 45); Arguments = " --nvidia --pers=firo --ocX" }
    [PSCustomObject]@{ Algorithm = "KawPoW";           Type = "NVIDIA"; Fee = @(0.01);   MinMemGB = $Pools."KawPoW".DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 35); Arguments = " --nvidia --par=Kawpow --dag-fix --pers=RAVENCOINKAWPOW" }
