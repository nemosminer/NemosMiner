...
$URI = "https://github.com/sp-hash/TeamBlackMiner/releases/download/v2.13/TeamBlackMiner_2_13_cuda_12_0.7z"
...
$Algorithms = @(
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "EthashB3");  Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(45, 45);  ExcludeGPUArchitecture = @("RDNA1"); ExcludePools = @(@(), @());                             Arguments = " --algo etc+ethb3" } # https://github.com/sp-hash/TeamBlackMiner/issues/423
    [PSCustomObject]@{ Algorithms = @("EtcHash", "KawPow");    Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(90, 45);  ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @("HashCryptos", "MiningDutch")); Arguments = " --algo etc+rvn" } #https://github.com/sp-hash/TeamBlackMiner/issues/424
    [PSCustomObject]@{ Algorithms = @("EtcHash", "VertHash");  Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 1; Tuning = ""; WarmupTimes = @(120, 30); ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @());                             Arguments = " --algo etc+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # 120 Seconds; https://github.com/sp-hash/TeamBlackMiner/issues/399
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "EthashB3");   Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(45, 15);  ExcludeGPUArchitecture = @("RDNA1"); ExcludePools = @(@(), @());                             Arguments = " --algo eth+ethb3" } # https://github.com/sp-hash/TeamBlackMiner/issues/423
    [PSCustomObject]@{ Algorithms = @("Ethash", "KawPow");     Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(90, 45);  ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @("HashCryptos", "MiningDutch")); Arguments = " --algo eth+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/424
    [PSCustomObject]@{ Algorithms = @("Ethash", "VertHash");   Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 1; Tuning = ""; WarmupTimes = @(120, 15); ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @());                             Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # 120 Secs; https://github.com/sp-hash/TeamBlackMiner/issues/399
...
#   [PSCustomObject]@{ Algorithms = @("EthashB3", "KawPow");   Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(90, 45);  ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @());                             Arguments = " --algo ethb3+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/422
    [PSCustomObject]@{ Algorithms = @("EthashB3", "VertHash"); Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 1; Tuning = ""; WarmupTimes = @(120, 30); ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @());                             Arguments = " --algo ethb3+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" } # 120 Seconds; https://github.com/sp-hash/TeamBlackMiner/issues/399
