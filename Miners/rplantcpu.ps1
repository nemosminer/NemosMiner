...
$Path = ".\Bin\CPU-Opt4030\cpuminer-sse42.exe" #Intel
#$Path = ".\Bin\CPU-Opt4030\cpuminer-ryzen.exe" #AMD
$Uri = "https://github.com/rplant8/cpuminer-opt-rplant/releases/download/4.0.30/cpuminer-opt-win.zip"
