...
$Path = ".\Bin\CPU-Opt4022\cpuminer-sse42.exe" #Intel
#$Path = ".\Bin\CPU-Opt4022\cpuminer-ryzen.exe" #AMD
$Uri = "https://github.com/rplant8/cpuminer-opt-rplant/releases/download/4.0.22/cpuminer-opt-win.zip"
