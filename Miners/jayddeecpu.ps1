...
#$Path = ".\Bin\CPU-JayDDee3107\cpuminer-zen.exe" #AMD
$Path = ".\Bin\CPU-JayDDee3107\cpuminer-aes-sse42.exe" #Intel
$Uri = "https://github.com/JayDDee/cpuminer-opt/releases/download/v3.10.7/cpuminer-opt-3.10.7-windows.zipp"
