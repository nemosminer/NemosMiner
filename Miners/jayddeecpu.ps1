...
#$Path = ".\Bin\CPU-JayDDee3120\cpuminer-zen.exe" #AMD
$Path = ".\Bin\CPU-JayDDee3120\cpuminer-aes-sse42.exe" #Intel
$Uri = "https://github.com/JayDDee/cpuminer-opt/releases/download/v3.12.0/cpuminer-opt-3.12.0-windows.zip"
