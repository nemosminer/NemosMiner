...
$Path = ".\Bin\CPU-JayDDee3111\cpuminer-aes-sse42.exe" #Intel
$Uri = "https://github.com/JayDDee/cpuminer-opt/releases/download/v3.11.1/cpuminer-opt-3.11.1-windows.zip"
