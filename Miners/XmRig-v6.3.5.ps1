...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "CryptonightCcx";       MinMemGB = 1;    Type = "AMD"; Command = " --algo cn/ccx" } #SRBMminerMulti-v0.5.4 is fastest, but has 0.85% miner fee
...
#   [PSCustomObject]@{ Algorithm = "CryptonightDouble";    Type = "CPU"; Command = " --algo cn/double" } #XmrStak-v2.10.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               MinMemGB = 3;    Type = "NVIDIA"; Command = " --algo kawpow" } #Trex-v0.18.5 is fastest, but has 1% miner fee
