...
$URI = "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.77b/lolMiner_v1.77b_Win64.zip"
$Name = (Get-Item $MyInvocation.MyCommand.Path).BaseName
$Path = "$PWD\Bin\$($Name)\lolminer.exe"
$DeviceEnumerator = "Bus"

$Algorithms = @(
    [PSCustomObject]@{ Algorithms = @("Autolykos2");                 Type = "AMD"; Fee = @(0.015);      MinMemGiB = 1.24; Minerset = 1; WarmupTimes = @(45, 20); ExcludeGPUArchitecture = @("RDNA3");                        ExcludePools = @(@(), @()); Arguments = " --algo AUTOLYKOS2" }
    ...
    [PSCustomObject]@{ Algorithms = @("Cuckoo29");                   Type = "AMD"; Fee = @(0.02);       MinMemGiB = 8.0;  MinerSet = 0; WarmupTimes = @(45, 70); ExcludeGPUArchitecture = @("RDNA3");                        ExcludePools = @(@(), @()); Arguments = " --algo C29AE" }
...
#   [PSCustomObject]@{ Algorithms = @("Cuckatoo32");                 Type = "AMD"; Fee = @(0.02);       MinMemGiB = 4.0;  Minerset = 3; WarmupTimes = @(60, 70); ExcludeGPUArchitecture = @("RDNA3");                        ExcludePools = @(@(), @()); Arguments = " --algo C32" } # ASIC
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "kHeavyHash");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @("RDNA1");                        ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KASPADUAL" }
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "kHeavyHash");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @("RDNA1");                        ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KASPADUAL" }
    [PSCustomObject]@{ Algorithms = @("EthashB3");                   Type = "AMD"; Fee = @(0.01);       MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 70); ExcludeGPUArchitecture = @("GCN1", "GCN2", "GCN3", "GCN4"); ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3" }
...
#   [PSCustomObject]@{ Algorithms = @("kHeavyHash");                 Type = "AMD"; Fee = @(0.0075);     MinMemGiB = 2.0;  Minerset = 1; WarmupTimes = @(60, 50); ExcludeGPUArchitecture = @("RDNA3");                        ExcludePools = @(@(), @()); Arguments = " --algo KASPA" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1972
    ...
    [PSCustomObject]@{ Algorithms = @("UbqHash");                    Type = "AMD"; Fee = @(0.007);      MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(60, 70); ExcludeGPUArchitecture = @("RDNA3");                        ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH" }
    [PSCustomObject]@{ Algorithms = @("UbqHash", "Blake3");          Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = @("RDNA3");                        ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode ALEPHDUAL" }
    [PSCustomObject]@{ Algorithms = @("UbqHash", "kHeavyHash");      Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = @("RDNA1", "RDNA3");               ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode KASPADUAL" }
    [PSCustomObject]@{ Algorithms = @("SHA512256d");                 Type = "AMD"; Fee = @(0.007);      MinMemGiB = 1.00; MinerSet = 0; WarmupTimes = @(60, 70); ExcludeGPUArchitecture = @();                               ExcludePools = @(@(), @()); Arguments = " --algo RADIANT" }
...
#   [PSCustomObject]@{ Algorithms = @("Cuckatoo32");                 Type = "NVIDIA"; Fee = @(0.02);       MinMemGiB = 4.0;  Minerset = 3; WarmupTimes = @(60, 60); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo C32" } # ASIC
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash");                    Type = "NVIDIA"; Fee = @(0.007);      MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(45, 70); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH" } # PhoenixMiner-v6.2c is faster
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "kHeavyHash");      Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 1; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETCHASH --dualmode KASPADUAL --maxdualimpact *" }
    [PSCustomObject]@{ Algorithms = @("Ethash");                     Type = "NVIDIA"; Fee = @(0.007);      MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 70); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETHASH" } # PhoenixMiner-v6.2c is faster
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "kHeavyHash");       Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode KASPADUAL --maxdualimpact *" }
    [PSCustomObject]@{ Algorithms = @("Ethash3B");                   Type = "NVIDIA"; Fee = @(0.01);       MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 70); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3" }
...
#   [PSCustomObject]@{ Algorithms = @("kHeavyHash");                 Type = "NVIDIA"; Fee = @(0.0075);     MinMemGiB = 2.0;  MinerSet = 0; WarmupTimes = @(60, 50); ExcludeGPUArchitecture = @("Other", "Pascal"); ExcludePools = @(@(), @()); Arguments = " --algo KASPA" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1972
    ...
    [PSCustomObject]@{ Algorithms = @("UbqHash");                    Type = "NVIDIA"; Fee = @(0.007);      MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(60, 70); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH" }
    [PSCustomObject]@{ Algorithms = @("UbqHash", "Blake3");          Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode ALEPHDUAL --maxdualimpact *" }
    [PSCustomObject]@{ Algorithms = @("UbqHash", "kHeavyHash");      Type = "NVIDIA"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; MinerSet = 0; WarmupTimes = @(60, 90); ExcludeGPUArchitecture = @();                  ExcludePools = @(@(), @()); Arguments = " --algo UBQHASH --dualmode KASPADUAL --maxdualimpact *" }
    [PSCustomObject]@{ Algorithms = @("SHA512256d");                 Type = "NVIDIA"; Fee = @(0.007);      MinMemGiB = 1.00; Minerset = 2; WarmupTimes = @(60, 70); ExcludeGPUArchitecture = @("Other");           ExcludePools = @(@(), @()); Arguments = " --algo RADIANT" }
)
...
If ($Algorithms) { 
    ...
    $Devices | Select-Object Type, Model -Unique | ForEach-Object { 
        ...
        $Algorithms | Where-Object Type -EQ $_.Type | ForEach-Object { 
            ...
            ForEach ($Pool0 in ($MinerPools[0][$_.Algorithms[0]] | Where-Object Name -notin $ExcludePools[0])) { 
                ForEach ($Pool1 in ($MinerPools[1][$_.Algorithms[1]] | Where-Object Name -notin $ExcludePools[1])) { 
