...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "IronFish");        Fee = @(0.007, 0.007); MinMemGiB = 0.84; Tuning = " --mt2"; MinerSet = 0; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @());        Arguments = " --algorithm etchash+ironfish" }
    [PSCustomObject]@{ Algorithms = @("EtcHash", "kHeavyHash");      Fee = @(0.007, 0.007); MinMemGiB = 0.84; Tuning = " --mt2"; MinerSet = 0; WarmupTimes = @(55, 25); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @());        Arguments = " --algorithm etchash+kheavyhash" }
    ...
    [PSCustomObject]@{ Algorithms = @("KawPow");                     Fee = @(0.01);         MinMemGiB = 0.84; Tuning = " --mt2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @());        Arguments = " --algorithm ravencoin" }
