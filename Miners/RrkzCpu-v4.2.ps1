...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    [PSCustomObject]@{ Algorithm = "CpuPower"; MinerSet = 0; WarmupTimes = @(0, 15); Arguments = " --algo cpupower" } # SRBMinerMulti-v0.7.9 is fastest, but has 0.85% miner fee
    ...
    If ($Miner_Devices = @($Devices | Where-Object Type -EQ "CPU")) { 
        ...
        $Miner_Devices | Select-Object Model -Unique | ForEach-Object { 
            ...
            $AlgorithmDefinitions | ForEach-Object {
                ...
                # $_.Arguments = Get-ArgumentsPerDevice -Arguments $_ .Command -ExcludeArguments @("algo") -DeviceIDs $Miner_Devices.$DeviceEnumerator
