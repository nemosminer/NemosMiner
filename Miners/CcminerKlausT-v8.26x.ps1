...
$Uri = Switch ($DriverVersion.CUDA) { 
    { $_ -ge "11.4" } { "https://github.com/Minerx117/miners/releases/download/CcminerKlaust/ccminerklaust-826x-cuda114-x64.7z"; Break }
    { $_ -ge "10.2" } { "https://github.com/Minerx117/miners/releases/download/CcminerKlaust/ccminerklaust-826x-cuda102-x64.7z"; Break }
    Default { Return }
}
...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "NeoscryptXaya"; MinMemGB = 2; MinerSet = 2; WarmupTimes = @(30, 0);  Arguments = " --algo neoscrypt-xaya --intensity 15.5" } # CryptoDredge-v0.26.0 is fastest
