...
$Algorithms = @(
    ...
    # [PSCustomObject]@{ Algorithms = @("PowBlocks", "kHeavyHash");  Fee = @(0.007, 0.007); MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @("Other"); ExcludePools = @(@(), @());        Arguments = " --algorithm powblocks+kheavyhash" }
