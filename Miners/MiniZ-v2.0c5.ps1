...
#   [PSCustomObject]@{ Algorithm = "EthashLowMem";     Type = "AMD"; Fee = @(0.0075); MinMemGiB = 1.08; Minerset = 2; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @("GCN1", "GCN2", "GCN3", "RDNA1");                  Arguments = " --amd --par=Ethash --dag-fix" } # TTMiner-v5.0.3 is fastest
...
#   [PSCustomObject]@{ Algorithm = "EthashLowMem";     Type = "NVIDIA"; Fee = @(0.0075); MinMemGiB = 1.08; Minerset = 2; Tuning = " --ocX"; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @(); Arguments = " --nvidia --par=Ethash --dag-fix" } # TTMiner-v5.0.3 is fastest
