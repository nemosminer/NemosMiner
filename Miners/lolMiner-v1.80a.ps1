...
$URI = "https://github.com/Lolliedieb/lolMiner-releases/releases/download/1.80a/lolMiner_v1.80a_Win64.zip"
...
#   [PSCustomObject]@{ Algorithms = @("Ethash", "SHA512256d");       Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @("RDNA1"); ExcludePools = @(@(), @()); Arguments = " --algo ETHASH --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1986
...
#   [PSCustomObject]@{ Algorithms = @("EthashB3", "KarlsenHash");    Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode KARLSENDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1989
#   [PSCustomObject]@{ Algorithms = @("EthashB3", "kHeavyHash");     Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode KASPADUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1989
#   [PSCustomObject]@{ Algorithms = @("EthashB3", "SHA512256d");     Type = "AMD"; Fee = @(0.01, 0.01); MinMemGiB = 1.24; Minerset = 2; WarmupTimes = @(45, 90); ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @()); Arguments = " --algo ETHASHB3 --dualmode RXDDUAL" } # https://github.com/Lolliedieb/lolMiner-releases/issues/1989
