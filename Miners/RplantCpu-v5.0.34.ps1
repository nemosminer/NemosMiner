...
#   [PSCustomObject]@{ Algorithm = "X11";           Minerset = 3; WarmupTimes = @(30, 15);  ExcludePools = @();        Srguments = " --algo x11" } # ASIC, algorithm not supported
    ...
    [PSCustomObject]@{ Algorithm = "YespowerUrx";   Minerset = 2; WarmupTimes = @(45, 0);   ExcludePools = @();        Arguments = " --algo yespowerURX" } # JayddeeCpu-v3.23.2 is faster, SRBMminerMulti is fastest, but has 0.85% miner fee
)
