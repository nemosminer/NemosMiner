...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = @("CuckarooD29");                Type = "AMD"; Fee = @(0.01);       MinMemGB = 4.0;                                   MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(45, 30); Arguments = " --algo C29D" } # TeamRedMiner-v0.10.3 is fastest, keep enabled because TeamRed does not support algo on Navi
    ...
    [PSCustomObject]@{ Algorithm = @("Cuckatoo31");                 Type = "AMD"; Fee = @(0.02);       MinMemGB = 4.0;                                   MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(60, 60); Arguments = " --algo C31" } # TeamRedMiner-v0.10.3 is fastest
    ...
    [PSCustomObject]@{ Algorithm = @("CuckarooD29");                Type = "NVIDIA"; Fee = @(0.01);       MinMemGB = 4.0;                                   MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(45, 30); Arguments = " --algo C29D" } # GMiner-v3.06 is fastest
