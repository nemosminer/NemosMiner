...
$Commands = [PSCustomObject]@{
    "hsr" = " -N 1 -r 0 -d $SelGPUCC" #Hsr(fastest)
    "poly" = " -N 1 -r 0 -d $SelGPUCC" #polytimos(fastest)
    #"bitcore" = "" #Bitcore
    ...
    #"groestl" = "" #Groestl
    #"hmq1725" = "" #hmq1725
    "keccak" = " -N 1 -r 0 -m 2 -i 29 -d $SelGPUCC" #Keccak(fastest)
    "keccakc" = " -N 1 -r 0 -i 29 -d $SelGPUCC" #Keccakc(fastest)
    ...
    "skein" = " -N 1 -r 0 -d $SelGPUCC" #Skein(fastest)
    #"timetravel" = "" #Timetravel
    "c11" = " -N 1 -r 0 -i 21 -d $SelGPUCC" #C11(fastest)
    "x11evo" = " -r 0 -N 1 -i 21 -d $SelGPUCC " #X11evo(fastest)
    #"x11gost" = " -i 21 -d $SelGPUCC --api-remote" #X11gost
    "x17" = " -N 1 -r 0 -i 20 -d $SelGPUCC" #X17(fastest)
    #"yescrypt" = "" #Yescrypt
}
