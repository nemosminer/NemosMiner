...
$Algorithms = [PSCustomObject[]]@( 
     [PSCustomObject]@{ Algorithm = @("0x10");                      Type = "AMD"; Fee = @(0.0085);       MinMemGB = 2;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(60, 45); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm 0x10" }
     [PSCustomObject]@{ Algorithm = @("Argon2d16000");              Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(60, 15); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm argon2d_16000" }
     [PSCustomObject]@{ Algorithm = @("Argon2d500");                Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(60, 45); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm argon2d_dynamic" }
     [PSCustomObject]@{ Algorithm = @("Argon2Chukwa");              Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(60, 45); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm argon2id_chukwa" }
     [PSCustomObject]@{ Algorithm = @("Argon2Chukwa2");             Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(60, 45); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm argon2id_chukwa2" }
     [PSCustomObject]@{ Algorithm = @("Autolykos2");                Type = "AMD"; Fee = @(0.01);         MinMemGB = $MinerPools[0].Autolykos2.DAGSizeGB;   MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm autolykos2" }
#    [PSCustomObject]@{ Algorithm = @("Autolykos2", "HeavyHash");   Type = "AMD"; Fee = @(0.0065, 0.01); MinMemGB = $MinerPools[0].Autolykos2.DAGSizeGB;   MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm autolykos2 --algorithm heavyhash" }
     [PSCustomObject]@{ Algorithm = @("Blake2b");                   Type = "AMD"; Fee = @(0);            MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @("Zpool")    ; Arguments = " --algorithm blake2b" } # Algorithm broken
     [PSCustomObject]@{ Algorithm = @("Blake2s");                   Type = "AMD"; Fee = @(0);            MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm blake2s" }
     [PSCustomObject]@{ Algorithm = @("Blake3");                    Type = "AMD"; Fee = @(0.0085);       MinMemGB = 2;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm blake3_alephium" }
     [PSCustomObject]@{ Algorithm = @("CircCash");                  Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm circcash" }
     [PSCustomObject]@{ Algorithm = @("CryptonightCcx");            Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm cryptonight_ccx" }
     ...
     [PSCustomObject]@{ Algorithm = @("EtcHash");                   Type = "AMD"; Fee = @(0.0065);       MinMemGB = $MinerPools[0].Etchash.DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(90, 75); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm etchash" } # PhoenixMiner-v6.2c may be faster, but I see lower speed at the pool
#    [PSCustomObject]@{ Algorithm = @("EtcHash", "HeavyHash");      Type = "AMD"; Fee = @(0.0065, 0.01); MinMemGB = $MinerPools[0].Etchash.DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(90, 75); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm etchash --algorithm heavyhash --gpu-auto-tune 2" }
     [PSCustomObject]@{ Algorithm = @("Ethash");                    Type = "AMD"; Fee = @(0.0065);       MinMemGB = $MinerPools[0].Ethash.DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(90, 75); ExcludeGPUArchitecture = @();        ExcludePool = @()           ; Arguments = " --algorithm ethash" } # PhoenixMiner-v6.2c may be faster, but I see lower speed at the pool
#    [PSCustomObject]@{ Algorithm = @("Ethash", "Heavyhash");       Type = "AMD"; Fee = @(0.0065, 0.01); MinMemGB = $MinerPools[0].Ethash.DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(90, 75); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm ethash --algorithm heavyhash --gpu-auto-tune 2" }
     [PSCustomObject]@{ Algorithm = @("EthashLowMem");              Type = "AMD"; Fee = @(0.0065);       MinMemGB = $MinerPools[0].EthashLowMem.DAGSizeGB; MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(90, 75); ExcludeGPUArchitecture = @();        ExcludePool = @("ProHashing"); Arguments = " --algorithm ethash" } # PhoenixMiner-v6.2c may be faster, but I see lower speed at the pool
#    [PSCustomObject]@{ Algorithm = @("EthashLowMem", "HeavyHash"); Type = "AMD"; Fee = @(0.0065, 0.01); MinMemGB = $MinerPools[0].EthashLowMem.DAGSizeGB; MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(90, 75); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm ethash --algorithm heavyhash --gpu-auto-tune 2" }
     [PSCustomObject]@{ Algorithm = @("FiroPoW");                   Type = "AMD"; Fee = @(0.0085);       MinMemGB = $MinerPools[0].FiroPoW.DAGSizeGB;      MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(60, 75); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm firopow" }
     [PSCustomObject]@{ Algorithm = @("FrkHash");                   Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm frkhash" }
     [PSCustomObject]@{ Algorithm = @("HeavyHash");                 Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm heavyhash" }
     [PSCustomObject]@{ Algorithm = @("Kangaroo12");                Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm k12" }
     [PSCustomObject]@{ Algorithm = @("kHeavyHash");                Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm kaspa" }
     [PSCustomObject]@{ Algorithm = @("KawPoW");                    Type = "AMD"; Fee = @(0.0085);       MinMemGB = $MinerPools[0].KawPoW.DAGSizeGB;       MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(90, 75); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm kawpow" }
#    [PSCustomObject]@{ Algorithm = @("Keccak");                    Type = "AMD"; Fee = @(0);            MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm keccak" } # ASIC
     [PSCustomObject]@{ Algorithm = @("Lyra2v2Webchain");           Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm lyra2v2_webchain" }
     [PSCustomObject]@{ Algorithm = @("ProgPoWEpic");               Type = "AMD"; Fee = @(0.0065);       MinMemGB = $MinerPools[0].ProgPoWEpic.DAGSizeGB;  MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm progpow_epic" }
     [PSCustomObject]@{ Algorithm = @("ProgPoWSero");               Type = "AMD"; Fee = @(0.0065);       MinMemGB = $MinerPools[0].ProgPoWSero.DAGSizeGB;  MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm progpow_sero" }
     [PSCustomObject]@{ Algorithm = @("ProgPoWVeil");               Type = "AMD"; Fee = @(0.0065);       MinMemGB = $MinerPools[0].ProgPoWVeil.DAGSizeGB;  MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm progpow_veil" }
     [PSCustomObject]@{ Algorithm = @("ProgPoWVeriblock");          Type = "AMD"; Fee = @(0.0065);       MinMemGB = 2;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm progpow_veriblock" }
     [PSCustomObject]@{ Algorithm = @("ProgPoWZ");                  Type = "AMD"; Fee = @(0.0065);       MinMemGB = $MinerPools[0].ProgPoWZ.DAGSizeGB;     MemReserveGB = 0.42; MinerSet = 0; WarmupTimes = @(45, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm progpow_zano" }
     [PSCustomObject]@{ Algorithm = @("Pufferfish2BMB");            Type = "AMD"; Fee = @(0.01);         MinMemGB = 8;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 0);  ExcludeGPUArchitecture = @("Other"); ExcludePool = @()            ; Arguments = " --algorithm pufferfish2bmb" }
     [PSCustomObject]@{ Algorithm = @("SHA512256d");                Type = "AMD"; Fee = @(0.01);         MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm sha512_256d_radiant" }
     [PSCustomObject]@{ Algorithm = @("SHA3d");                     Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm sha3d" }
     [PSCustomObject]@{ Algorithm = @("VerusHash");                 Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm verushash" }
     [PSCustomObject]@{ Algorithm = @("VertHash");                  Type = "AMD"; Fee = @(0.0125);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm verthash --verthash-dat-path ..\..\Cache\VertHash.dat" }
     [PSCustomObject]@{ Algorithm = @("Yescrypt");                  Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(90, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm yescrypt" }
     [PSCustomObject]@{ Algorithm = @("YescryptR8");                Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(90, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm yescryptr8" }
     [PSCustomObject]@{ Algorithm = @("YescryptR16");               Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(90, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm yescryptr16" }
     [PSCustomObject]@{ Algorithm = @("YescryptR32");               Type = "AMD"; Fee = @(0.0085);       MinMemGB = 1;                                     MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(90, 30); ExcludeGPUArchitecture = @();        ExcludePool = @()            ; Arguments = " --algorithm yescryptr32" }
...
#   [PSCustomObject]@{ Algorithm = @("Autolykos2");           Type = "CPU"; Fee = @(0.01);   MinerSet = 0; WarmupTimes = @(120, 15); ExcludePool = @()       ; Arguments = " --algorithm autolykos2 --gpu-autolykos2-preload 3" } # Not profitable with CPU
    ...
    [PSCustomObject]@{ Algorithm = @("CryptonightUpx");       Type = "CPU"; Fee = @(0.0085); MinerSet = 0; WarmupTimes = @(30, 15);  ExcludePool = @()       ; Arguments = " --algorithm cryptonight_upx" }
...
#   [PSCustomObject]@{ Algorithm = @("KawPoW");               Type = "CPU"; Fee = @(0.0085); MinerSet = 0; WarmupTimes = @(60, 0);   ExcludePool = @()       ; Arguments = " --algorithm kawpow" } # Not profitable with CPU
    [PSCustomObject]@{ Algorithm = @("kHeavyHash");           Type = "CPU"; Fee = @(0.0085); MinerSet = 0; WarmupTimes = @(30, 0);   ExcludePool = @()       ; Arguments = " --algorithm kaspa" }
#   [PSCustomObject]@{ Algorithm = @("Keccak");               Type = "CPU"; Fee = @(0);      MinerSet = 0; WarmupTimes = @(30, 0);   ExcludePool = @()       ; Arguments = " --algorithm keccak" } # ASIC
    ...
    [PSCustomObject]@{ Algorithm = @("SHA512256d");           Type = "CPU"; Fee = @(0.01);   MinerSet = 0; WarmupTimes = @(30, 30);  ExcludePool = @()       ; Arguments = " --algorithm sha512_256d_radiant" }
        ...
        $Algorithms | Where-Object Type -EQ $_.Type | Where-Object { $MinerPools[0].($_.Algorithm).BaseName -notin $_.ExcludePool } | Select-Object | ConvertTo-Json | ConvertFrom-Json | ForEach-Object { 
            ...
            If ($AvailableMiner_Devices = $Miner_Devices | Where-Object { $_.Type -eq "CPU" -or ($_.MemoryGB -gt $MinMemGB) } | Where-Object { $_.Architecture -notin $ExcludeGPUArchitecture }) { 
                ...
                If ($_.Algorithm[1]) { 
                    ...
                    If ($MinerPools[0].($_.Algorithm[1]).WorkerName) { $_.Arguments += " --worker $($MinerPools[0].($_.Algorithm[1]).WorkerName)" }
