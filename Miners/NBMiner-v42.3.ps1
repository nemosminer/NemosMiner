...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "Cuckoo29";     Type = "NVIDIA"; Fee = 0.02; MinMemGB = 5;                                     MemReserveGB = 0;    AdditionalWin10MemGB = 1; MinComputeCapability = 6.0; MinerSet = 1; Tuning = " -mt 1"; WarmupTimes = @(30, 0);  Arguments = " --algo cuckoo_ae --platform 1" } # GMiner-v3.07 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "Octopus";      Type = "NVIDIA"; Fee = 0.03; MinMemGB = $MinerPools[0].Octopus.DAGSizeGB;      MemReserveGB = 0.41; AdditionalWin10MemGB = 1; MinComputeCapability = 6.1; MinerSet = 1; Tuning = " -mt 1"; WarmupTimes = @(45, 0);  Arguments = " --algo octopus --platform 1" } # Trex-v0.26.6 is fastest
)
