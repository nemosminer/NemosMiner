...
$Path = ".\Bin\NVIDIA-ccminertpruvot231anime\ccminer.exe"
$Uri = "https://github.com/Minerx117/ccminer/releases/download/v2.3.1/ccminer-anime.7z"
$Commands = [PSCustomObject]@{ 
    #"blake2b" = " --cpu-priority 4 -a blake2b" #blake2b
    "anime"       = " --cpu-priority 4 -a anime -i 20" #anime
