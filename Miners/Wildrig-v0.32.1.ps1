...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "FiroPoW";          Type = "AMD"; Fee = @(0.01); MinMemGB = $Pools."FiroPoW".DAGSizeGB; MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(55, 45); Arguments = " --algo firopow" }
...
#   [PSCustomObject]@{ Algorithm = "Sha256t";          Type = "AMD"; Fee = @(0.01); MinMemGB = 2;                          MemReserveGB = 0;    MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo sha256t" } # Takes too long until it starts mining
    ...
    [PSCustomObject]@{ Algorithm = "FiroPoW";          Type = "NVIDIA"; Fee = @(0.01); MinMemGB = $Pools."FiroPoW".DAGSizeGB; MemReserveGB = 0.42; MinerSet = 1; WarmupTimes = @(55, 45); Arguments = " --algo firopow --watchdog" }
