...
#   [PSCustomObject]@{ Algorithm = "Lyra2RE2";  MinMemGB = 3; MinerSet = 0; WarmupTimes = @(30, 0); Arguments = " --algo lyra2v2" } # ASIC
...
#   [PSCustomObject]@{ Algorithm = "Skein";     MinMemGB = 3; MinerSet = 0; WarmupTimes = @(30, 0); Arguments = " --algo skein" } # ASIC
