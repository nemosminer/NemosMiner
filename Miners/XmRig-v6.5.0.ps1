...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "CryptonightCcx";       Type = "AMD"; MinMemGB = 1;    Command = " --algo cn/ccx" } #SRBMminerMulti-v0.5.8 is fastest, but has 0.85% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "AMD"; MinMemGB = 3;    Command = " --algo kawpow" } #NBMiner-v34.4 is fastest, but has 1% miner fee
...
#   [PSCustomObject]@{ Algorithm = "CryptonightDouble";    Type = "CPU"; Command = " --algo cn/double" } #XmrStak-v2.10.8 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "RandomxArq";           Type = "CPU"; Command = " --algo rx/arq" } #SRBMminerMulti-v0.5.8 is fastest, but has 0.85% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "RandomxSfx";           Type = "CPU"; Command = " --algo rx/sfx" } #SRBMminerMulti-v0.5.8 is fastest, but has 0.85% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "NVIDIA"; MinMemGB = 3;    Command = " --algo kawpow" } #Trex-v0.19.1 is fastest, but has 1% miner fee
