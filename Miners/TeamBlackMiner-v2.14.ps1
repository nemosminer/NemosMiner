...
$URI = "https://github.com/sp-hash/TeamBlackMiner/releases/download/v2.14/TeamBlackMiner_2_14_cuda_12_0.7z"
...
$Algorithms = @(
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "EthashB3");  Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(45, 45);  ExcludeGPUArchitecture = @("_RDNA1"); ExcludePools = @(@(), @()); Arguments = " --algo etc+ethb3" } # https://github.com/sp-hash/TeamBlackMiner/issues/428
    [PSCustomObject]@{ Algorithms = @("EtcHash", "FiroPow");   Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(45, 45);  ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @()); Arguments = " --algo etc+efiro" }
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "EthashB3");   Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(45, 15);  ExcludeGPUArchitecture = @("_RDNA1"); ExcludePools = @(@(), @()); Arguments = " --algo eth+ethb3" } # https://github.com/sp-hash/TeamBlackMiner/issues/428
