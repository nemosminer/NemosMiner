...
If ($Devices = @($Devices | Where-Object Type -EQ "NVIDIA")) { Return }

$Uri = Switch ($DriverVersion.CUDA) { 
    { $_ -ge "11.1" } { "https://github.com/Minerx117/miners/releases/download/Z-Enemy/z-enemy-2.6.3-win-cuda11.1.zip" }
    Default { Return }
}
