...
$URI = "https://github.com/rigelminer/rigel/releases/download/1.12.0/rigel-1.12.0-win.zip"
...
$Algorithms = @(
    ...
    [PSCustomObject]@{ Algorithms = @("KawPow");                    Fee = @(0.01);         MinMemGiB = 0.94; Tuning = " --mt 2"; MinerSet = 0; WarmupTimes = @(45, 10); ExcludeGPUArchitecture = @(); ExcludePools = @(@(), @());        Arguments = " --algorithm ravencoin" }
