...
$URI = "https://github.com/sp-hash/TeamBlackMiner/releases/download/v2.08/TeamBlackMiner_2_08_cuda_12_2.7z"
...
$Algorithms = @(
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "KawPow");   Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(45, 45); ExcludeGPUArchitecture = @("RDNA1"); ExcludePools = @(@(), @());                                           Arguments = " --algo etc+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/403
    [PSCustomObject]@{ Algorithms = @("EtcHash", "VertHash"); Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 1; Tuning = ""; WarmupTimes = @(60, 45); ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @());                                           Arguments = " --algo etc+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "KawPow");    Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = ""; WarmupTimes = @(45, 45); ExcludeGPUArchitecture = @("RDNA1"); ExcludePools = @(@(), @());                                           Arguments = " --algo eth+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/403
    [PSCustomObject]@{ Algorithms = @("Ethash", "VertHash");  Type = "AMD"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 1; Tuning = ""; WarmupTimes = @(60, 45); ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @());                                           Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
    [PSCustomObject]@{ Algorithms = @("KawPow");              Type = "AMD"; Fee = @(0.005);        MinMemGiB = 1.24; Minerset = 2; Tuning = ""; WarmupTimes = @(60, 15); ExcludeGPUArchitecture = @();        ExcludePools = @(@("HashCryptos", "MiningDutch", "ProHashing"), @()); Arguments = " --algo kawpow" } # https://github.com/sp-hash/TeamBlackMiner/issues/405
    [PSCustomObject]@{ Algorithms = @("VertHash");            Type = "AMD"; Fee = @(0.005);        MinMemGiB = 3.0;  Minerset = 1; Tuning = ""; WarmupTimes = @(60, 0);  ExcludeGPUArchitecture = @();        ExcludePools = @(@(), @());                                           Arguments = " --algo verthash --verthash-data ..\.$($Variables.VerthashDatPath)" }
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "Ethash3B"); Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 1; Tuning = " --tweak 2"; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @();         ExcludePools = @(@(), @());                                           Arguments = " --algo etc+ethb3" }
    [PSCustomObject]@{ Algorithms = @("EtcHash", "KawPow");   Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); ExcludeGPUArchitecture = @("Turing"); ExcludePools = @(@(), @("HashCryptos", "MiningDutch", "ProHashing")); Arguments = " --algo etc+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/396 & https://github.com/sp-hash/TeamBlackMiner/issues/405
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "Ethash3B");  Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 1; Tuning = " --tweak 2"; WarmupTimes = @(45, 15); ExcludeGPUArchitecture = @();         ExcludePools = @(@(), @());                                           Arguments = " --algo eth+ethb3" }
    [PSCustomObject]@{ Algorithms = @("Ethash", "KawPow");    Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); ExcludeGPUArchitecture = @("Turing"); ExcludePools = @(@(), @("HashCryptos", "MiningDutch", "ProHashing")); Arguments = " --algo eth+rvn" } # https://github.com/sp-hash/TeamBlackMiner/issues/400 & https://github.com/sp-hash/TeamBlackMiner/issues/405
    [PSCustomObject]@{ Algorithms = @("Ethash", "VertHash");  Type = "NVIDIA"; Fee = @(0.005, 0.005); MinMemGiB = 1.51; Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(45, 45); ExcludeGPUArchitecture = @();         ExcludePools = @(@(), @());                                           Arguments = " --algo eth+vtc --verthash-data ..\.$($Variables.VerthashDatPath)" }
    ...
    [PSCustomObject]@{ Algorithms = @("KawPow");              Type = "NVIDIA"; Fee = @(0.005);        MinMemGiB = 1.24; Minerset = 2; Tuning = " --tweak 2"; WarmupTimes = @(60, 30); ExcludeGPUArchitecture = @("Turing"); ExcludePools = @(@("HashCryptos", "MiningDutch", "ProHashing"), @()); Arguments = " --algo kawpow" } # https://github.com/sp-hash/TeamBlackMiner/issues/400 & https://github.com/sp-hash/TeamBlackMiner/issues/405
    [PSCustomObject]@{ Algorithms = @("VertHash");            Type = "NVIDIA"; Fee = @(0.005);        MinMemGiB = 3.0;  MinerSet = 0; Tuning = " --tweak 2"; WarmupTimes = @(60, 60); ExcludeGPUArchitecture = @();         ExcludePools = @(@(), @());                                           Arguments = " --algo verthash --verthash-data ..\.$($Variables.VerthashDatPath)" }
)
