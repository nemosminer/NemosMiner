...
#   "C11"       = " --algo c11 --intensity 22" #X11evo; fix for default intensity, CcminerAlexis78 is fastest
...
#   "X17"       = " --algo x17 --intensity 22" #x17; fix for default intensity, #CcminerAlexis78 is faster
}
