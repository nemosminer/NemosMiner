...
$Commands = [PSCustomObject]@{
    ...
    "cryptonight" = " -d $SelGPUCC" #Cryptonight(works with 6-8gpus no api runs in wrapper)
    "cryptonightV7" = " -d $SelGPUCC" #CryptonightV7(works with 6-8gpus no api runs in wrapper)
    #"decred" = "" #Decred
    #"equihash" = "" #Equihash
    #"ethash" = "" #Ethash
