...
$URI = "https://github.com/bzminer/bzminer/releases/download/v16.0.0/bzminer_v16.0.0_windows.zip"
...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash3B");   Type = "AMD"; Fee = 0.01;  MinMemGiB = 1.08; Minerset = 1; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 20); ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @();           Arguments = @(" -a rethereum") }
    [PSCustomObject]@{ Algorithms = @("IronFish");   Type = "AMD"; Fee = 0.01;  MinMemGiB = 2;    Minerset = 1; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(60, 60); ExcludePools = @(@("Nicehash"), @()); ExcludeGPUArchitecture = @(); Arguments = @(" -a ironfish") }# https://github.com/bzminer/bzminer/issues/260
    [PSCustomObject]@{ Algorithms = @("KawPow");     Type = "AMD"; Fee = 0.01;  MinMemGiB = 1.08; Minerset = 2; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 0);  ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @("GCN4");     Arguments = @(" -a rvn") } # https://github.com/bzminer/bzminer/issues/264
    ...
    [PSCustomObject]@{ Algorithms = @("Autolykos2", "kHeavyHash"); Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 1.24; Minerset = 1; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60); ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @();           Arguments = @(" -a ergo", " --a2 kaspa") }
    [PSCustomObject]@{ Algorithms = @("Autolykos2", "SHA512256d"); Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 1.24; Minerset = 1; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60); ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @();           Arguments = @(" -a ergo", " --a2 radiant") }
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "IronFish");      Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 1.24; Minerset = 2; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60); ExcludePools = @(@(), @("Nicehash")); ExcludeGPUArchitecture = @(); Arguments = @(" -a etchash", " --a2 ironfish") } # https://github.com/bzminer/bzminer/issues/260
    ...
    [PSCustomObject]@{ Algorithms = @("EtcHash", "SHA512256d");    Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 1.24; Minerset = 2; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(60, 60); ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @();           Arguments = @(" -a etchash", " --a2 radiant") }
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash3B");                 Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 1.08; MinerSet = 1; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 20); ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @();           Arguments = @(" -a rethereum") }
    ...
    [PSCustomObject]@{ Algorithms = @("Ethash", "IronFish");       Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 1.24; Minerset = 2; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60); ExcludePools = @(@(), @("Nicehash")); ExcludeGPUArchitecture = @(); Arguments = @(" -a ethash", " --a2 ironfish") } # https://github.com/bzminer/bzminer/issues/260
    ...
    [PSCustomObject]@{ Algorithms = @("IronFish");                 Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 2;    Minerset = 1; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(60, 60); ExcludePools = @(@("Nicehash"), @()); ExcludeGPUArchitecture = @(); Arguments = @(" -a ironfish") } # https://github.com/bzminer/bzminer/issues/260
    ...
    [PSCustomObject]@{ Algorithms = @("OctaSpace", "Blake3");      Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 3;    Minerset = 2; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60); ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @();           Arguments = @(" -a octa", " --a2 alph") }
    [PSCustomObject]@{ Algorithms = @("OctaSpace", "IronFish");    Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 3;    Minerset = 2; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60); ExcludePools = @(@(), @("Nicehash")); ExcludeGPUArchitecture = @(); Arguments = @(" -a octa", " --a2 ironfish") } # https://github.com/bzminer/bzminer/issues/260
    [PSCustomObject]@{ Algorithms = @("OctaSpace", "kHeavyHash");  Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 3;    Minerset = 2; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60); ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @();           Arguments = @(" -a octa", " --a2 kaspa") }
    [PSCustomObject]@{ Algorithms = @("OctaSpace", "SHA512256d");  Type = "NVIDIA"; Fee = 0.01;  MinMemGiB = 3;    Minerset = 2; Tuning = " --oc_mem_tweak 2"; WarmupTimes = @(45, 60); ExcludePools = @(@(), @()); ExcludeGPUArchitecture = @();           Arguments = @(" -a octa", " --a2 radiant") }
