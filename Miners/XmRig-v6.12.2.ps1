...
$AlgorithmDefinitions = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "CryptonightCcx";       Type = "AMD"; MinMemGB = 1;    MinerSet = 2; WarmupTimes = @(0, 30); Arguments = " --algo cn/ccx" } # SRBMinerMulti-v0.7.9 is fastest, but has 0.85% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "AMD"; MinMemGB = 3;    MinerSet = 2; WarmupTimes = @(0, 45); Arguments = " --algo kawpow" } # NBMiner-v38.2 is fastest, but has 2% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "RandomxArq";           Type = "CPU"; MinerSet = 0; WarmupTimes = @(0, 30); Arguments = " --algo rx/arq" } # SRBMinerMulti-v0.7.9 is fastest, but has 0.85% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "RandomxSfx";           Type = "CPU"; MinerSet = 0; WarmupTimes = @(0, 30); Arguments = " --algo rx/sfx" } # SRBMinerMulti-v0.7.9 is fastest, but has 0.85% miner fee
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";               Type = "NVIDIA"; MinMemGB = 3;    MinerSet = 0; WarmupTimes = @(0, 45); Arguments = " --algo kawpow" } # Trex-v0.21.5 is fastest, but has 1% miner fee
