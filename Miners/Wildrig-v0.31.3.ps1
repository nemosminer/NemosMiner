...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";      Type = "AMD"; Fee = @(0.01); MinMemGB = ($Pools."KawPoW".DAGSize + $DAGmemReserve) / 1GB;; MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo kawpow" } # TeamRedMiner-v0.9.4.1 is fastest on Navi
    ...
    [PSCustomObject]@{ Algorithm = "JeongHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                                 MinerSet = 0; WarmupTimes = @(30, 15); Arguments = " --algo glt-jeonghash" } # Trex-v0.25.9 is fastest
    [PSCustomObject]@{ Algorithm = "KawPoW";      Type = "NVIDIA"; Fee = @(0.01); MinMemGB = ($Pools."KawPoW".DAGSize + $DAGmemReserve) / 1GB;; MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo kawpow" } # NBMiner-v40.1 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "MTP";         Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3;                                                 MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo mtp" } # Trex-v0.25.9 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "PawelHash";   Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                                 MinerSet = 0; WarmupTimes = @(45, 0);  Arguments = " --algo glt-pawelhash" } # Trex-v0.25.9 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "Sonoa";       Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                                 MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo sonoa" } # Trex-v0.25.9 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X16r";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                                 MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo x16r" } # Trex-v0.25.9 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X16s";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                                 MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x16s" } # Trex-v0.25.9 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "X21s";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 2;                                                 MinerSet = 1; WarmupTimes = @(30, 15); Arguments = " --algo x21s" } # Trex-v0.25.9 is fastest
    # [PSCustomObject]@{ Algorithm = "X22i";        Type = "NVIDIA"; Fee = @(0.01); MinMemGB = 3;                                                 MinerSet = 1; WarmupTimes = @(60, 15); Arguments = " --algo x22i" } # No results; Trex-v0.25.9 is fastest
