...
$Algorithms = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";      Type = "AMD"; Fee = @(0.01); MinMemGB = ($Pools."KawPoW".DAGSize + $1.5GB) / 1GB;; MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo kawpow" } # TeamRedMiner-v0.9.4.1 is fastest on Navi
    ...
    [PSCustomObject]@{ Algorithm = "KawPoW";      Type = "NVIDIA"; Fee = @(0.01); MinMemGB = ($Pools."KawPoW".DAGSize + $1.5GB) / 1GB;; MinerSet = 1; WarmupTimes = @(45, 0);  Arguments = " --algo kawpow" } # NBMiner-v40.1 is fastest
