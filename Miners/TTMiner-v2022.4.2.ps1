...
#   [PSCustomObject]@{ Algorithm = "EthashLowMem";     Fee = 0.01; MinMemGB = $MinerPools[0].EthashLowMem.DAGSizeGB;MemReserveGB = 0.41; MinerSet = 1; WarmupTimes = @(60, 15); ExcludeGPUArchitecture = @();        ExcludePool = @();                      Arguments = " -algo Ethash -dag-2disk" }
    ...
    [PSCustomObject]@{ Algorithm = "Ghostrider";       Fee = 0.02; MinMemGB = 1;                                    MemReserveGB = 0;    MinerSet = 1; WarmupTimes = @(60, 15); ExcludeGPUArchitecture = @("Other"); ExcludePool = @("ProHashing", "ZPool"); Arguments = " -algo Ghostrider" }
