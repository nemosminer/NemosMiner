...
#   [PSCustomObject]@{ Algorithm = "RandomX";   Type = "CPU"; Fee = 0.02; MinerSet = 1; WarmupTimes = @(45, 0); Arguments = " -algo RandomX" } # Not profitable at all
    ...
    [PSCustomObject]@{ Algorithm = "EtcHash";      Type = "NVIDIA"; Fee = 0.01;  MinMemGB = $MinerPools[0].EtcHash.DAGSizeGB + 0.42;      MinerSet = 1; Tuning = " -coreClocks +20 -memClocks +100"; WarmupTimes = @(55, 0);  ExcludePool = @();                            ExcludeGPUArchitecture = @(); Arguments = " -algo Etchash" } # PhoenixMiner-v6.2c is fastest
    [PSCustomObject]@{ Algorithm = "Ethash";       Type = "NVIDIA"; Fee = 0.01;  MinMemGB = $MinerPools[0].Ethash.DAGSizeGB + 0.42;       MinerSet = 1; Tuning = " -coreClocks +20 -memClocks +100"; WarmupTimes = @(55, 0);  ExcludePool = @();                            ExcludeGPUArchitecture = @(); Arguments = " -algo Ethash" } # PhoenixMiner-v6.2c is fastest
#   [PSCustomObject]@{ Algorithm = "EthashLowMem"; Type = "NVIDIA"; Fee = 0.01;  MinMemGB = $MinerPools[0].EthashLowMem.DAGSizeGB + 0.42; MinerSet = 1; Tuning = " -coreClocks +20 -memClocks +100"; WarmupTimes = @(55, 0);  ExcludePool = @();                            ExcludeGPUArchitecture = @(); Arguments = " -algo Ethash" } # TTMiner-v5.0.3 is fastest
    ...
    [PSCustomObject]@{ Algorithm = "FiroPow";      Type = "NVIDIA"; Fee = 0.01;  MinMemGB = $MinerPools[0].FiroPow.DAGSizeGB + 0.42;      MinerSet = 1; Tuning = " -coreClocks +20 -memClocks +100"; WarmupTimes = @(55, 0);  ExcludePool = @();                            ExcludeGPUArchitecture = @(); Arguments = " -algo FiroPow"}
    [PSCustomObject]@{ Algorithm = "KawPow";       Type = "NVIDIA"; Fee = 0.02;  MinMemGB = $MinerPools[0].KawPow.DAGSizeGB + 0.42;       MinerSet = 1; Tuning = " -coreClocks +20 -memClocks +100"; WarmupTimes = @(75, 0);  ExcludePool = @("MiningDutch", "ProHashing"); ExcludeGPUArchitecture = @(); Arguments = " -algo KawPow" } # Trex-v0.26.8 is fastest
    [PSCustomObject]@{ Algorithm = "Octopus";      Type = "NVIDIA"; Fee = 0.02;  MinMemGB = $MinerPools[0].Octopus.DAGSizeGB + 0.42;      MinerSet = 1; Tuning = " -coreClocks +20 -memClocks +100"; WarmupTimes = @(125, 0); ExcludePool = @();                            ExcludeGPUArchitecture = @(); Arguments = " -algo Octopus" } # NBMiner-v42.3 is faster
    ...
    [PSCustomObject]@{ Algorithm = "EtcHash";      Type = "INTEL"; Fee = 0.01;  MinMemGB = $MinerPools[0].EtcHash.DAGSizeGB + 0.42;      MinerSet = 1; WarmupTimes = @(55, 45); ExcludePool = @(); ExcludeGPUArchitecture = @(); Arguments = " -algo Etchash" }
    [PSCustomObject]@{ Algorithm = "Ethash";       Type = "INTEL"; Fee = 0.01;  MinMemGB = $MinerPools[0].Ethash.DAGSizeGB + 0.42;       MinerSet = 1; WarmupTimes = @(55, 0);  ExcludePool = @(); ExcludeGPUArchitecture = @(); Arguments = " -algo Ethash" }
#   [PSCustomObject]@{ Algorithm = "EthashLowMem"; Type = "INTEL"; Fee = 0.01;  MinMemGB = $MinerPools[0].EthashLowMem.DAGSizeGB + 0.42; MinerSet = 1; WarmupTimes = @(55, 0);  ExcludePool = @(); ExcludeGPUArchitecture = @(); Arguments = " -algo Ethash" }
    [PSCustomObject]@{ Algorithm = "EvrProgPow";   Type = "INTEL"; Fee = 0.02;  MinMemGB = $MinerPools[0].EvrProgPow.DAGSizeGB + 0.42;   MinerSet = 1; WarmupTimes = @(55, 0);  ExcludePool = @(); ExcludeGPUArchitecture = @(); Arguments = " -algo Evrprogpow" }
    [PSCustomObject]@{ Algorithm = "KawPow";       Type = "INTEL"; Fee = 0.02;  MinMemGB = $MinerPools[0].KawPow.DAGSizeGB + 0.42;       MinerSet = 1; WarmupTimes = @(75, 0);  ExcludePool = @(); ExcludeGPUArchitecture = @(); Arguments = " -algo KawPow" } # Trex-v0.26.8 is fastest
    [PSCustomObject]@{ Algorithm = "Octopus";      Type = "INTEL"; Fee = 0.02;  MinMemGB = $MinerPools[0].Octopus.DAGSizeGB + 0.42;      MinerSet = 1; WarmupTimes = @(125, 0); ExcludePool = @(); ExcludeGPUArchitecture = @(); Arguments = " -algo Octopus" } # NBMiner-v42.3 is faster
